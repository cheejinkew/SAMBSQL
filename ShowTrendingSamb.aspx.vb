...
Imports System.IO
Partial Class ShowTrendingSamb
    ...
    Private Sub GetEquipmentPosition()
        ...
        Try
            ...
            Dim OdbcCmd As OdbcCommand
            Dim strsql As String
            strsql = "Select position,sdesc FROM telemetry_equip_list_table where equipname='" & ddlEquipment.SelectedValue & "'"
            OdbcCmd = New OdbcCommand(strsql, odbc_Conn)
            odbc_Conn.Open()
            Odbcdr = OdbcCmd.ExecuteReader
            While Odbcdr.Read
    ...
    Private Sub CaptureTrendingbyTime(ByVal strstartdate As String, ByVal strEndDate As String, ByVal filename As String)
        ...
        'Set the plotarea at (30, 20) and of size 200 x 200 pixels
        c.setPlotArea(90, 30, 450, 310).setGridColor(&HFBCCF9, &HFBCCF9)
