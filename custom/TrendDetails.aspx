...
<table width="410" border="1">
  <tr>
    <td><div align="center"><a href="Trending.aspx?siteid=<%=siteid%>&sitename=<%=sitename%>&district=<%=district%>&equipname=<%=equipname%>&position=<%=Position%>" onclick="history.go(-1);return false;" target="main">Trending Selection</a></div></td>
  </tr>
</table>
