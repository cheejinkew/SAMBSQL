    ...
    <div style="height: 330px">
        ...
        <table class="style1">
            ...
            <tr>
                ...
                <td class="style5">
            <p align="right" style="width: 696px"><b><font size="1" face="Verdana"><a href="AddUserSamb.aspx">Add New User</a></font></b></td>
            </tr>
            <tr>
                <td class="style8">
                    </td>
                <td colspan="2" class="style9" align="center">
                   <asp:GridView ID="usergrid" runat="server" AutoGenerateColumns="False" HeaderStyle-Font-Size="12px"
                                ...
                                Width="70%" EnableModelValidation="True">
                                <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="username">
                                            ...
                                            <ItemStyle Font-Bold="True" Font-Italic="False" Font-Names="Verdana" 
                                                Font-Overline="False" Font-Size="Smaller" ForeColor="#0099FF" />
                                        </asp:TemplateField>
