   ...
   <div>
	...
	' ==================================== Checks should anywhere here =============================================
            If Not sequence1(0) = "" Then
                ...
                step1 = intInterval
                XMLData1 = "<chart fontcolor='333333' topmargin='0' labelStep='" & step1 & "' fontSize='10' isBold='1' showBorder='0' chartLeftMargin='30' bgColor='FFFFFF' slantLabels='1' labelDisplay='Rotate' caption='" & caption & "'  xAxisName='Time Stamp' yAxisName='jdadad' numberSuffix='m' showNames='1' showValues='0' rotateNames='1' showColumnShadow='1' animation='1' yAxisMaxValue='" & strMaxYaxis & "' showAlternateHGridColor='1' AlternateHGridColor='ff5904' divLineColor='91AF46' divLineAlpha='30' alternateHGridAlpha='5' canvasBorderColor='666666' baseFontColor='666666' lineColor='008000' numVDivlines='7' lineAlpha='50'>" & extra & " <trendLines> " & alerts & " </trendLines></chart>"
    ...
    <script type="text/javascript">
 	 var myChart = new FusionCharts("Charts/Line(2).swf?r="+ Math.random() ,"Div2", "400", "300", "0", "0");
