...
<%
	...
	dim bgcolor = "#ADD8E6"
	dim oricolor = "#ADD8E6"
    Dim siteid() As String = {"8630", "8571", "8510", "8508", "8509", "8569", "8570", "8572", "8577", "8639", "8574", "8573","8637"}
%>
<html>
<head>
    <meta content="text/html; charset=iso-8859-1" http-equiv="Content-Type">
    <title>mimic 01</title>
    <meta name="Microsoft Border" content="none, default" />
<!--#include file="style.inc"-->
</head>
<body>
	<div id="header">LOJI MERLIMAU</div>
	<div class="mainbox">	
		<div class="childbox" style="left:0px;">
			<div class="lagenda" style="position:relative;top:40%;left:2px;">
				...
				<div class="rightP" style="top:29px;left:199px;"></div>
			</div>
		</div>
		<div class="Vline" style="height:415px;top:85px;left:225px;"></div>
		<div class="childbox" style="left:250px;">
			<div class="lagenda" style="position:absolute;top:50px;left:2px;">
				<div class="rightP" style="top:29px;left:-25px;"></div>
		...
		<div class="Vline" style="height:100px;top:40px;left:475px;"></div>
		<div class="Vline" style="height:190px;top:400px;left:475px;"></div>
		<div class="childbox" style="left:500px;">
			<div class="lagenda" style="position:absolute;top:5px;left:2px;">
				<div class="rightG" style="top:29px;left:-25px;"></div>
		...
		<div class="Vline" style="height:100px;top:180px;left:725px;"></div>
		<div class="childbox" style="left:750px;">
			<div class="lagenda" style="position:absolute;top:145px;left:2px;">
				<div class="rightG" style="top:29px;left:-25px;"></div>
			...
			<div class="lagenda" style="position:absolute;top:235px;left:2px;">
				<div class="rightP" style="top:29px;left:-25px;"></div>
...
<%
response.write(UBound(siteid) & "<br />" & LBound(siteid))
%>	
</body>
