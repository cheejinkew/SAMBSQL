...
<%
	dim page_title = "Hualon2-lot1500_TanggaBatu"
%>
...
<div id="BPH" style="Z-INDEX:1;LEFT:2px;POSITION:absolute;TOP:1px">
			<img src="img/Hualon2-lot1500_TanggaBatu.gif">
			...
			<!-- level -->
			<!--<div id="water_level1" style="Z-INDEX:2;BACKGROUND:none transparent scroll repeat 0% 0%;LEFT:360px;WIDTH:309px;POSITION:absolute;TOP:200px;HEIGHT:60px">
				<div id="show_level1color" class="waterlevel"><img id="show_level1" src="../images/blank.gif" width="309" height="10"></div>
			</div>-->
			<!-- indicator -->
			<div id="rtu_stat1" style="Z-INDEX:3;LEFT:80px;POSITION:absolute;TOP:40px" class="rtu_island">
				<div id="rtu_stat1_title" style="LEFT:3px;POSITION:absolute;TOP:0px" class="labelhead">RTU#</div>
			</div>
			<div style="Z-INDEX:3;LEFT:500px;CURSOR:pointer;POSITION:absolute;TOP:20px">
			...
			<div style="Z-INDEX:3;LEFT:300px;CURSOR:pointer;POSITION:absolute;TOP:205px">
