...
<form method="post" name="frmUnitConfig" action="MelakaUnitConfig.aspx">
                          ...
                          <%
                             ...
                             objConn.open(strConn)
                              ...
                              sqlRs.Open("SELECT simno, pwd, versionid, s.siteid, u.unitid, s.sitedistrict || ' : ' || " & _
                                         ...
                                         "where s.siteid IN ("& strKontID &") and s.unitid = u.unitid order by sitedistrict, sitetype, sitename", objConn)
                              'else
                              ' sqlRs.Open("SELECT simno, pwd, versionid, s.siteid, u.unitid, s.sitedistrict || ' : ' || " & _
                              '            "s.sitetype || ' : ' || s.sitename as sites " & _
                              '            "from telemetry_site_list_table s, unit_list u " & _
                              '            "where s.unitid = u.unitid order by sitedistrict, sitetype, sitename", objConn)
                              'end if
