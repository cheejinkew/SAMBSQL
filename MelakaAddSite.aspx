...
document.getElementById("txttype").value="True";
}
else
{
document.getElementById("ddUnit").value="none";
document.getElementById("txttype").value="False";
}
}
</script>
</head>
<body>
<form name="frmAddSite" method="post" action="MelakaAddSite.aspx">
<div align="center">
  <center>
          ...
          <table border="0" cellpadding="5" width="350" height="63">
            ...
            <tr>
              ...
              <td width="325" height="26"><font color="#0B3D62">
                <select name="ddUnit" id="ddUnit" class="FormDropdown">
                ...
                <select name="ddAssociate" class="FormDropdown1">
                  ...
                  <%
                    objConn = new ADODB.Connection()
                      ...
                      sqlRs.Open("SELECT distinct (siteid), sitetype || ' : ' || sitename as sites " & _
                                 " from telemetry_site_list_table where sitedistrict='" & strSelectedSite & "' and siteid in ('STEF','STF1','STF0','F330')", objConn)
                    
                      Do While Not sqlRs.EOF
                          
                          
                          intAsscID = sqlRs("siteid").value
                          'intAsscID = sqlRs("sitename").value
                   %>
                   <option value="<%=intAsscID%>"><%=sqlRs("sites").value%></option>
                   <%
                       'intAsscID.Items.Add(New ListItem(sqlRs("sitename").Value, sqlRs("siteid").Value))
                   ...
                   objConn = Nothing
                  %>
                  <option value="F330">Besut:F3 Flowmeter:P Perhentian Besar</option>
                </select>
                </font>
               </td>
            </tr>
            ...
            <tr>
              ...
              <td width="325" height="26"><font color="#0B3D62">
                <input type="text" name="txtComment" class="inputStyle" value="<%=strComment%>">
                 <input type="hidden" name="txttype" class="inputStyle" value="">
               </td>
            </tr>
            <tr>
            ...
            <tr>
             <td width="100" style="height: 52px">
                <b><font size="1" face="Verdana" color="#5373A2">Select</font></b></td>
             <td style="width: 20px; height: 52px">
                <b><font color="#5373A2">:</font></b></td>
             <td width="325" height="26">
               <font color="#0B3D62">
               <input type="radio" name="rd" checked="checked" id="rd1" onclick ="javascript:fun_change();"/>Installed site
                 <input type="radio" name="rd"  id="rd2" onclick ="javascript:fun_change();" />Uninstalled site
              </font>
             </td>
            </tr>
            <tr>
...
<script language="javascript">
 ...
 document.frmAddSite.txtAddress.value = '<%=strAddress%>';
  ...
  function goAddSite()
  {
    if (document.frmAddSite.ddUnit.value=="0")
    {
    ...
    else if (document.frmAddSite.ddDistrict.value=="0")
    {
    if( document.getElementById('rd1').checked==true )
      {
