<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bph_LAG_43_6.aspx.vb" Inherits="custom_bph_LAG_43_6" %>
...
<body  bgcolor="#0071bb">
    ...
    <div style ="background-image :url(imej/LAG_43_6.png?r=199182392);height:745px;width :1050px;" >
    ...
    <div id="water_level1" title="Suction Tank" style="position:absolute;z-index:2;top:567px;left:238px;width:110px;;height:50px;background:transparent">
     ...
     <div id="water_level2" title="Suction Tank" style="position:absolute;z-index:2;top:469px;left:422px;width:110px;height:50px;background:transparent">
		<div id="show_level2color" class="waterlevel"><img id="show_level2" src="../images/blank.gif" width="62" height="10"></div>
	</div>
      <div id="water_level3" title="Suction Tank" style="position:absolute;z-index:2;top:557px;left:607px;width:110px;height:50px;background:transparent">
		<div id="show_level3color" class="waterlevel"><img id="show_level3" src="../images/blank.gif" width="62" height="10"></div>
	</div>
         <div id="water_level4" title="Suction Tank" style="position:absolute;z-index:2;top:514px;left:792px;width:110px;height:50px;background:transparent">
   ...
   <div style="position:absolute;top:489px;left:422px;z-index:2;"> 
      <div id="l_level3_value"  class="black_box">???</div> 
    </div>

      <div style="position:absolute;top:577px;left:607px;z-index:2;"> 
      <div id="l_level4_value"  class="black_box">???</div> 
    </div>
    <div style="position:absolute;top:534px;left:792px;z-index:2;"> 
