...
<%
  ...
  sqlRs.Open("SELECT versionid, unitid, multiplier, measurement, max, sitetype, equiptype, equipname, ""desc"" as name " & _
             "from telemetry_equip_list_table where siteid='" & intSiteID & _
             "' and index='" & intSelectedIndex & "' and position ='" & intSelectedPosition & "'" ,objConn)
...
<p align="center" style="margin-bottom: 15">
  <font size="1" face="Verdana" color="#5373A2">
     Copyright © 2005 Gussmann Sdn Bhd. All rights reserved.
  </font>
</p>
</body>
