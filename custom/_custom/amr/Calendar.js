...
{
  var strLayout = "<style>.SelectStyle{font-family:verdana;}</style><div id='divTWCalendar' style='position:absolute; left:-400; top:100; Z-INDEX: 5;border-width: 1px;border-style: solid;border-color: #4960F8;'>" +
