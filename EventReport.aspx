...
<form name="frmReport" action="EventReport.aspx" method="POST">
<script language="javascript">DrawCalendarLayout();</script>

<div align="center">
<br>
<p ><img border="0" src="images/EventReport.jpg">
<br>
<div align="center">
  <center>
        ...
        <div align="center">
          <table border="0" cellspacing="1" width="100%">
            ...
            <tr>
              ...
              <td width="3%"><font face="Verdana" size="1" color="#5F7AFC"><b>:</b></font></td>
              <td width="87%"><input type="text" name="txtEndDate" size="12" style="border: 1 solid #5F7AFC ; font-family: Verdana; font-size: 10pt; color: #3952F9; height: 20"
            ...
            <tr>
              <td width="4%"></td>
              <td width="16%"><font face="Verdana" size="1" color="#5F7AFC"><b>Event Type</b></font></td>
              <td width="3%"><font face="Verdana" size="1" color="#5F7AFC"><b>:</b></font></td>
