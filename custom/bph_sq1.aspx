<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bph_sq1.aspx.vb" Inherits="custom_bph_sq1" %>
...
<body  bgcolor="#0071bb">
    ...
    <div style ="background-image :url(imej/47A.png?r=199182392);height:745px;width :1000px;" >
    
    </div>
    
    <div id="water_level1" title="Suction Tank" style="position:absolute;z-index:2;top:550px;left:148px;width:110px;;height:50px;background:transparent">
		<div id="show_level1color" class="waterlevel"><img id="show_level1" src="../images/blank.gif" width="62" height="10"></div>
	</div>
     <div id="water_level2" title="Suction Tank" style="position:absolute;z-index:2;top:543px;left:397px;width:110px;height:50px;background:transparent">
		<div id="show_level2color" class="waterlevel"><img id="show_level2" src="../images/blank.gif" width="62" height="10"></div>
	</div>
      <div id="water_level3" title="Suction Tank" style="position:absolute;z-index:2;top:568px;left:645px;width:110px;height:50px;background:transparent">
		<div id="show_level3color" class="waterlevel"><img id="show_level3" src="../images/blank.gif" width="62" height="10"></div>
	</div>
         <div id="water_level4" title="Suction Tank" style="position:absolute;z-index:2;top:597px;left:895px;width:110px;height:50px;background:transparent">
		<div id="show_level4color" class="waterlevel"><img id="show_level4" src="../images/blank.gif" width="62" height="10"></div>
	</div>
    <div style="position:absolute;top:580px;left:148px;z-index:2;"> 
      <div id="l_level2_value"  class="black_box">???</div> 
    </div>
   
   <div style="position:absolute;top:573px;left:395px;z-index:2;"> 
      <div id="l_level3_value"  class="black_box">???</div> 
    </div>

      <div style="position:absolute;top:597px;left:645px;z-index:2;"> 
      <div id="l_level4_value"  class="black_box">???</div> 
    </div>
    <div style="position:absolute;top:630px;left:896px;z-index:2;"> 
