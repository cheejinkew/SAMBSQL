...
<%
	...
	dim bgcolor = "#ADD8E6"
	dim oricolor = "#ADD8E6"
    Dim siteid() As String = {"8575", "8514", "8576", "8507", "8506", "8628", "8578", "8522", "8578","8549"}
%>
<html>
<head>
    <meta content="text/html; charset=iso-8859-1" http-equiv="Content-Type">
    <title>mimic 03</title>
...
<body>
    ...
    <div class="mainbox">
        <div class="childbox" style="left: 0px;">
            <div class="lagenda" style="position: relative; top: 50px; left: 2px;">
        ...
        <div class="Vline" style="height: 100px; top: 40px; left: 225px;">
        </div>
        ...
        <div class="childbox" style="left: 500px;">
            <div class="Hright" style="position: absolute; top: 35px; left: -25px; width: 250px;">
            </div>
            <div class="Hright" style="position: absolute; top: 125px; left: -25px; width: 250px;">
            </div>
            <!--<div class="lagenda" style="position:relative;top:95px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="sitename" class="titlebox" style="background:<%=oricolor%>">RUMAH PAM SPG.BEKOH</div>
        ...
        <div class="Vline" style="height: 190px; top: 130px; left: 725px;">
        </div>
        ...
        <div class="Vline" style="height: 190px; top: 130px; left: 975px;">
        </div>
        ...
        <div class="childbox" style="left: 1250px;">
            <div class="lagenda" style="position: absolute; top: 185px; left: 2px;">
                <div class="right" style="top: 29px; left: -25px;">
                </div>
