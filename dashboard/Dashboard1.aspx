<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard1.aspx.cs" Inherits="dashboard_Dashboard1" %>
            ...
            <div class="row">
                ...
                <section class="col-lg-6 connectedSortable">
                    ...
                    <div class="box  box-info box-solid" style="background-color: #ffffff;">
                        ...
                        <div class="box-body chat" id="Div2">
                            <div class="chart tab-pane active" id="WQ-chart" style="position: relative; height: 400px;"></div>
                        </div>
                    </div>
                </section>
                <!-- right col -->
...
<script type="text/javascript">
    ...
    function getdata() {
        ...
        $.ajax({
            type: "POST",
            url: "dashboard1.aspx/GetDashBoardJson",
            data: '{sDist: \"' + sDist + '\"}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
    ...
    function getQualityData() {
        ...
        $.ajax({
            type: "POST",
            url: "dashboard1.aspx/GetQualityWaterDataJson",
            data: '{sDist: \"' + sDist + '\"}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                var seriesdata = response.d;
                Highcharts.chart('WQ-chart', {
                    chart: {
                        type: 'bar'
                    },
                    title: {
                        text: 'MONTHLY PERFORMANCE WTP '
                    },
                    subtitle: {
                        text: ''
                    },
                    xAxis: {
                        categories: response.d.sitename,
                        title: {
                            text: null
                        }
                    },
