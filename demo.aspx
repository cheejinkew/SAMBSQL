            ...
            If CaptchaControl1.UserValidated Then
                If Not sqlRs.EOF Then
                    If sqlRs("pwd").value = strPassword Then
                        ...
                        ElseIf sqlRs("role").value = "User" Then
        ...
        <td height="202"><table width="800" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          ...
          <tr>
            <td height="85%"><table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td valign="top"><form id="frmLogin" name="frmLogin" method="post" runat="server" action="demo.aspx">
                <font color="red" size="2" face="Verdana"><b> <div align="center" id="Error"><%=strError%></div></b></font>
                  ...
                  <table width="387" height="272" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01">
                    ...
                    <tr>
                      ...
                      <td rowspan="7" style="width: 16px" ><img src="avlsimages/loginPage2_05.jpg" width="13" height="225" alt=""></td>
                    </tr>
                    <tr>
                        
                      <td rowspan="6" style="width: 14px"><img src="avlsimages/loginPage2_25.jpg" width="13" alt="" style="height: 225px"></td>
                      <td><img src="avlsimages/loginPage2_07.jpg" height="87" alt=""></td>
                    </tr>
                    <tr>
                      <td colspan="6" style="height: 55px"><img src="avlsimages/loginPage2_08.jpg" width="361" height="55" alt="" id="IMG1" onclick="return IMG1_onclick()"></td>
                    </tr>
                    <tr>
                      <td colspan="2" style="height: 30px"><img src="avlsimages/loginPage2_09.jpg" width="97" height="31" alt=""></td>
                      <td colspan="3" bgcolor="#E0DFE4" style="height: 30px"><div align="center">
                        <input type="text" name="txtUsername" class="inputStyle" value="<%=strLogin%>" size="20"/>
                      </div></td>
                      <td style="width: 4px; height: 30px" ><img src="avlsimages/loginPage2_11.jpg" width="3" height="31" alt=""></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td style="width: 4px" ><img src="avlsimages/loginPage2_17.jpg" width="3" height="31" alt=""></td>
                    </tr>
                    <tr>
                     <td colspan="6" style="height: 18px"><img src="avlsimages/loginPage2_18.jpg" width="361" height="18" alt=""></td>
                    </tr>
<%--                    <tr> <td colspan="9" style="height: 6px; width: 300px; left:500px"><cc1:captchacontrol id="CaptchaControl1" runat="server" Height="15px" Width="334px" Font-Names=Verdana Font-Size="Smaller" CaptchaBackgroundNoise=High   ></cc1:captchacontrol></td>                    </tr>--%>
                   <tr>
                     <td><img src="avlsimages/loginPage2_06.jpg" width="11" height="55" alt=""/></td>
                    <td colspan="6" style align="center">
                    <cc1:captchacontrol id="CaptchaControl1" runat="server" Height="2px" Width="360px"  Font-Names="Verdana" Font-Size="Smaller" CaptchaBackgroundNoise="High"     ></cc1:captchacontrol>
                    </td>
                    <td style="width: 16px" ><img src="avlsimages/loginPage2_05.jpg" width="13" height="55" alt=""></td>
                    </tr>
                    <tr>
                      <td colspan="8" style="height: 6px"><img src="avlsimages/loginPage2_19.jpg" height="13" alt="" style="width: 388px"></td>
                    </tr>
                    
                    <tr>
                      <td colspan="4" style="height: 20px"><img src="avlsimages/loginPage2_20.jpg" width="173" height="26" alt=""></td>
                     
                      <td> <asp:ImageButton ID="ImageButton1" ImageUrl="avlsimages/loginPage2_21.jpg" runat="server" width="101" height="26" OnClientClick="return gotoSubmit();" /></td>
                      ...
                      <td colspan="2"><img src="avlsimages/loginPage2_22.jpg" width="100" height="26"  onclick="document.frmLogin.reset()" style="cursor:pointer"/></td>
                      <td style="width: 16px"><img src="avlsimages/loginPage2_23.jpg" width="13" height="26"/></td>
                    </tr>
                    <tr>
