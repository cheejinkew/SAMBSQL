<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LojiAirDaf05.aspx.vb" Inherits="LojiAirDaf05" %>
...
<body bgcolor="#0071bb">
    <form id="form1" runat="server">
        ...
        <div style="background-image: url(imej/LojiAirDaf1-05.png?r=199182392); height: 745px; width: 1050px;">
        </div>

        <div id="water_level1" title="Suction Tank" style="position: absolute; z-index: 2; top: 392px; left: 295px; width: 48px; height: 27px; background: transparent;">
            <div id="show_level1color" class="waterlevel">
                <img id="show_level1" src="../images/blank.gif" width="48" height="20" /></div>
        </div>
        <div id="water_level2" title="Suction Tank" style="position: absolute; z-index: 2; top:392px; left: 381px; width: 48px; height: 27px; background: transparent">
            <div id="show_level2color" class="waterlevel">
                <img id="show_level2" src="../images/blank.gif" width="48" height="20"></div>
        </div>
        <div id="water_level3" title="Suction Tank" style="position: absolute; z-index: 2; top: 505px; left: 395px; width: 48px; height: 27px; background: transparent">
            <div id="show_level3color" class="waterlevel">
                <img id="show_level3" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level4" title="Suction Tank" style="position: absolute; z-index: 2; top: 57px; left: 494px; width: 48px; height: 27px; background: transparent">
            <div id="show_level4color" class="waterlevel">
                <img id="show_level4" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level5" title="Suction Tank" style="position: absolute; z-index: 2; top: 123px; left: 494px; width: 48px; height: 27px; background: transparent">
            <div id="show_level5color" class="waterlevel">
                <img id="show_level5" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level6" title="Suction Tank" style="position: absolute; z-index: 2; top: 191px; left: 494px; width: 48px; height: 27px; background: transparent">
            <div id="show_level6color" class="waterlevel">
                <img id="show_level6" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level7" title="Suction Tank" style="position: absolute; z-index: 2; top: 247px; left: 494px; width: 48px; height: 27px; background: transparent">
            <div id="show_level7color" class="waterlevel">
                <img id="show_level7" src="../images/blank.gif" width="48" height="10"></div>
        </div>

        <div id="water_level8" title="Suction Tank" style="position: absolute; z-index: 2; top: 310px; left: 494px; width: 48px; height: 27px; background: transparent">
            <div id="show_level8color" class="waterlevel">
                <img id="show_level8" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level9" title="Suction Tank" style="position: absolute; z-index: 2; top: 435px; left:497px; width: 48px; height: 27px; background: transparent">
            <div id="show_level9color" class="waterlevel">
                <img id="show_level9" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level10" title="Suction Tank" style="position: absolute; z-index: 2; top: 558px; left: 497px; width: 48px; height: 27px; background: transparent">
            <div id="show_level10color" class="waterlevel">
                <img id="show_level10" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level11" title="Suction Tank" style="position: absolute; z-index: 2; top: 615px; left: 497px; width: 48px; height: 27px; background: transparent">
            <div id="show_level11color" class="waterlevel">
                <img id="show_level11" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level12" title="Suction Tank" style="position: absolute; z-index: 2; top: 678px; left: 497px; width: 48px; height: 27px; background: transparent">
            <div id="show_level12color" class="waterlevel">
                <img id="show_level12" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level13" title="Suction Tank" style="position: absolute; z-index: 2; top: 491px; left: 561px; width: 48px; height: 27px; background: transparent">
            <div id="show_level13color" class="waterlevel">
                <img id="show_level13" src="../images/blank.gif" width="48" height="10"></div>
        </div>
            <div id="water_level14" title="Suction Tank" style="position: absolute; z-index: 2; top: 55px; left: 686px; width: 25px; height: 26px; background: transparent">
            <div id="show_level14color" class="waterlevel">
                <img id="show_level14" src="../images/blank.gif" width="25" height="10"></div>
        </div>
          <div id="water_level15" title="Suction Tank" style="position: absolute; z-index: 2; top: 123px; left: 686px; width: 25px; height: 26px; background: transparent">
            <div id="show_level15color" class="waterlevel">
                <img id="show_level15" src="../images/blank.gif" width="25" height="10"></div>
        </div>
          <div id="water_level16" title="Suction Tank" style="position: absolute; z-index: 2; top: 348px; left: 686px; width: 25px; height: 26px; background: transparent">
            <div id="show_level16color" class="waterlevel">
                <img id="show_level16" src="../images/blank.gif" width="25" height="10"></div>
        </div>
      <div id="water_level17" title="Suction Tank" style="position: absolute; z-index: 2; top: 405px; left: 686px; width: 25px; height: 26px; background: transparent">
            <div id="show_level17color" class="waterlevel">
                <img id="show_level17" src="../images/blank.gif" width="25" height="10"></div>
        </div>
            <div id="water_level18" title="Suction Tank" style="position: absolute; z-index: 2; top: 521px; left: 672px; width: 48px; height: 27px; background: transparent">
            <div id="show_level18color" class="waterlevel">
                <img id="show_level18" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level19" title="Suction Tank" style="position: absolute; z-index: 2; top: 575px; left: 611px; width: 25px; height: 26px; background: transparent">
            <div id="show_level19color" class="waterlevel">
                <img id="show_level19" src="../images/blank.gif" width="25" height="10"></div>
        </div>
      <div id="water_level20" title="Suction Tank" style="position: absolute; z-index: 2; top: 520px; left: 773px; width: 25px; height: 26px; background: transparent">
            <div id="show_level20color" class="waterlevel">
                <img id="show_level20" src="../images/blank.gif" width="25" height="10"></div>
        </div>
        <div style="position: absolute; top: 392px; left: 302px; z-index: 2;">
            <div id="l_level2_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top: 392px; left: 387px; z-index: 2;">
            <div id="l_level3_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top: 505px; left: 402px; z-index: 2;">
            <div id="l_level4_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 57px; left: 501px; z-index: 2;">
            <div id="l_level5_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 123px; left: 501px; z-index: 2;">
            <div id="l_level6_value" class="black_box">???</div>
        </div>
           <div style="position: absolute; top: 191px; left:501px; z-index: 2;">
            <div id="l_level7_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 247px; left:501px; z-index: 2;">
            <div id="l_level8_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 310px; left: 501px; z-index: 2;">
            <div id="l_level9_value" class="black_box">???</div>
        </div>
         <div style="position: absolute; top:435px; left: 501px; z-index: 2;">
            <div id="l_level10_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 558px; left:501px; z-index: 2;">
            <div id="l_level11_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 615px; left: 501px; z-index: 2;">
            <div id="l_level12_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 678px; left: 501px; z-index: 2;">
            <div id="l_level13_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 491px; left: 568px; z-index: 2;">
            <div id="l_level14_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 57px; left: 695px; z-index: 2;">
            <div id="l_level15_value" class="black_box">???</div>
        </div>
           <div style="position: absolute; top: 123px; left: 695px; z-index: 2;">
            <div id="l_level16_value" class="black_box">???</div>
        </div>
           <div style="position: absolute; top: 348px; left: 695px; z-index: 2;">
            <div id="l_level17_value" class="black_box">???</div>
        </div>
           <div style="position: absolute; top: 405px; left: 695px; z-index: 2;">
            <div id="l_level18_value" class="black_box">???</div>
        </div>
           <div style="position: absolute; top: 521px; left: 677px; z-index: 2;">
            <div id="l_level19_value" class="black_box">???</div>
        </div>
           <div style="position: absolute; top: 575px; left: 618px; z-index: 2;">
            <div id="l_level20_value" class="black_box">???</div>
        </div>
           <div style="position: absolute; top: 520px; left: 780px; z-index: 2;">
            <div id="l_level21_value" class="black_box">???</div>
        </div>
          
                  <div id="link" title="Loji Air Gadek 2" style="position: absolute; z-index: 2; top: 590px; left: 877px; width: 110px; height: 50px; background: transparent" onclick="showextend('LojiAirDaf06')">
             <img id="next" src="../images/next2.png" width="48" height="30"/> 
         </div>
                <div id="link" title="Loji Air Gadek 2" style="position: absolute; z-index: 2; top: 590px; left: 77px; width: 110px; height: 50px; background: transparent" onclick="showextend('LojiAirDaf04')">
