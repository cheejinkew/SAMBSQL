...
<%
	dim page_title = "Hualon3-lot435,-TanggaBatu"
%>
...
<div id="BPH" style="Z-INDEX:1;LEFT:2px;POSITION:absolute;TOP:1px">
			<img src="img/Hualon3-lot435,-TanggaBatu.jpg">
<!--			<div onclick="window.location='_jkolam_3.aspx';" class="pointer" style="Z-INDEX:2;LEFT:4px;POSITION:absolute;TOP:383px"><img src="../images/left.jpg"></div>-->
			...
			<!-- level -->
			<!--<div id="water_level1" style="Z-INDEX:2;BACKGROUND:none transparent scroll repeat 0% 0%;LEFT:30px;WIDTH:309px;POSITION:absolute;TOP:340px;HEIGHT:60px">
				<div id="show_level1color" class="waterlevel"><img id="show_level1" src="../images/blank.gif" width="309" height="10"></div>
			</div>
			<div id="water_level2" style="Z-INDEX:3;BACKGROUND:none transparent scroll repeat 0% 0%;LEFT:350px;WIDTH:309px;POSITION:absolute;TOP:340px;HEIGHT:60px">
			...
			<div style="Z-INDEX:3;LEFT:290px;CURSOR:pointer;POSITION:absolute;TOP:45px">
			...
			<div style="Z-INDEX:3;LEFT:265px;CURSOR:pointer;POSITION:absolute;TOP:160px">
...
var arrdata = total_feed.split("|");
	...
	sv_element('Total1',r(arrdata[4]) + ' m<sup>3</sup>')
	sv_element('Flow2',r(arrdata[3]) + ' m<sup>3</sup>h')
	sv_element('Total2',r(arrdata[5]) + ' m<sup>3</sup>')
