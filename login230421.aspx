...
<body onload="goGetFocus();">
        ...
        <center>
            <table width="800" height="0px" border="0" cellpadding="0" cellspacing="0" style="border-width: 1px;
                ...
                <tr>
                    <td bgcolor="#FFFFFF">
                        <div align="center">
                            <img src="avlsimages/logo.jpg?r=<%=DateTime.Now.ToString()%>" width="800" height="72"></div>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td height="85%">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td valign="top">
                                                <form id="frmLogin" name="frmLogin" method="post" action="login.aspx" runat="server">
                                                ...
                                                <table width="387" height="272" border="0" align="center" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td colspan="8">
                                                            <img src="avlsimages/loginPage2_01.jpg?r=<%=DateTime.Now.ToString()%>" width="387" height="7" alt="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <img src="avlsimages/loginPage2_02.jpg?r=<%=DateTime.Now.ToString()%>" width="13" height="1" alt="">
                                                        </td>
                                                        <td>
                                                            <img src="avlsimages/loginPage2_03.jpg?r=<%=DateTime.Now.ToString()%>" width="1" height="1" alt="">
                                                        </td>
                                                        <td height="88" colspan="5" rowspan="2">
                                                            <img src="avlsimages//loginPage2_04.jpg?r=<%=DateTime.Now.ToString()%>" width="360" height="88" alt="">
                                                        </td>
                                                        <td rowspan="7">
                                                            <img src="avlsimages//loginPage2_05.jpg?r=<%=DateTime.Now.ToString()%>" width="13" height="225" alt="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td rowspan="6">
                                                            <img src="avlsimages/loginPage2_06.jpg?r=<%=DateTime.Now.ToString()%>" width="13" height="224" alt="">
                                                        </td>
                                                        <td>
                                                            <img src="avlsimages//loginPage2_07.jpg?r=<%=DateTime.Now.ToString()%>" width="1" height="87" alt="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6">
                                                            <img src="avlsimages/loginPage2_08.jpg?r=<%=DateTime.Now.ToString()%>" width="361" height="55" alt="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <img src="avlsimages/loginPage2_09.jpg?r=<%=DateTime.Now.ToString()%>" width="97" height="31" alt="">
                                                        </td>
                                                        ...
                                                        <td>
                                                            <img src="avlsimages//loginPage2_11.jpg" width="3" height="31" alt="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3">
                                                            <img src="avlsimages/loginPage2_12.jpg" width="160" height="2" alt="">
                                                        </td>
                                                        <td>
                                                            <img src="avlsimages/loginPage2_13.jpg" width="101" height="2" alt="">
                                                        </td>
                                                        <td colspan="2">
                                                            <img src="avlsimages/loginPage2_14.jpg" width="100" height="2" alt="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <img src="avlsimages/loginPage2_15.jpg" width="97" height="31" alt="">
                                                        </td>
                                                        <td colspan="3" bgcolor="#E0DFE4">
                                                            <div align="center">
                                                        ...
                                                        <td>
                                                            <img src="avlsimages/loginPage2_17.jpg" width="3" height="31" alt="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6">
                                                            <img src="avlsimages/loginPage2_18.jpg" width="361" height="18" alt="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <img src="avlsimages/loginPage2_06.jpg" width="13" alt="" style="height: 60px">
                                                        </td>
                                                        ...
                                                        <td>
                                                            <img src="avlsimages//loginPage2_05.jpg" width="13" alt="" style="height: 60px">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="8">
                                                            <img src="avlsimages/loginPage2_19.jpg" width="387" height="13" alt="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="4">
                                                            <img src="avlsimages/loginPage2_20.jpg" width="173" height="26" alt="">
                                                        </td>
                                                        <td>
                                                            ...
                                                            <asp:ImageButton ID="ImageButton1" ImageUrl="avlsimages/loginPage2_21.jpg" runat="server"
                                                                Width="101" Height="26" OnClientClick="return gotoSubmit();" />
                                                        </td>
                                                        <td colspan="2">
                                                        ...
                                                        <td>
                                                            <img src="avlsimages/loginPage2_23.jpg" width="13" height="26">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <img src="images/spacer.gif" width="13" height="1" alt="">
                                                        </td>
                                                        <td>
                                                            <img src="images/spacer.gif" width="1" height="1" alt="">
                                                        </td>
                                                        <td>
                                                            <img src="images/spacer.gif" width="96" height="1" alt="">
                                                        </td>
                                                        <td>
                                                            <img src="images/spacer.gif" width="63" height="1" alt="">
                                                        </td>
                                                        <td>
                                                            <img src="images/spacer.gif" width="101" height="1" alt="">
                                                        </td>
                                                        <td>
                                                            <img src="images/spacer.gif" width="97" height="1" alt="">
                                                        </td>
                                                        <td>
                                            ...
                                            <td valign="top">
                                                <table align="center" cellpadding="5" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="avlsimages/product.gif" width="174" height="151">
                                                        </td>
                                                    </tr>
                                                </table>
                                                <br>
    ...
    <p align="center" class="style9">
        ...
        Copyright &copy; 2007 <span class="style10">Global Telematics Sdn Bhd</span>. All
        rights reserved<br />
