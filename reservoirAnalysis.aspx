<%@ Page Language="VB" AutoEventWireup="false" CodeFile="reservoirAnalysis.aspx.vb" Inherits="reservoirAnalysis" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#txtfromdate").datepicker({ dateFormat: 'yy/mm/dd', minDate: -360, maxDate: +0, changeMonth: true, changeYear: true, numberOfMonths: 2
            });

            $("#txtEnddate").datepicker({ dateFormat: 'yy/mm/dd', minDate: -360, maxDate: +0, changeMonth: true, changeYear: true, numberOfMonths: 2
            ...
            <table width="80%">
                <tr>
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="average" HeaderText="Average Level (M)">
                            <ItemStyle HorizontalAlign="left" Width="15%" />
                        </asp:BoundField>
                          <asp:BoundField DataField="max" HeaderText="Max Level (M)">
                            <ItemStyle HorizontalAlign="left" Width="15%" />
                        </asp:BoundField>
                          <asp:BoundField DataField="min" HeaderText="Min Level (M)">
                            <ItemStyle HorizontalAlign="left" Width="15%" />
                        </asp:BoundField>
                          <asp:BoundField DataField="median" HeaderText="Median Level (M)">
