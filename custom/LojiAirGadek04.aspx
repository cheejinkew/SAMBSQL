<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LojiAirGadek04.aspx.vb" Inherits="LojiAirGadek04" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetData() {
           ...
           var url_22 = "../ajx/CustomFeedData1.aspx?ID=" + SiteID_21;
           ...
           if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera, Safari
               ...
               xmlhttp_22 = new ActiveXObject("Microsoft.XMLHTTP");
           }
           ...
           xmlhttp_22.onreadystatechange = function () {
               if (xmlhttp_22.readyState == 4 && xmlhttp_22.status == 200) {
                   var data = xmlhttp_22.responseText;
                   Fill_Res_Data(data, 22);
               }
           }
           ...
           xmlhttp_21.send();
           xmlhttp_22.open("GET", url_22, true);
           xmlhttp_22.send();
...
<body bgcolor="#0071bb">
    <form id="form1" runat="server">
        ...
        <div style="background-image: url(imej/LAG04.png?r=199182392); height: 745px; width: 1050px;">
        </div>

        <div id="water_level1" title="Suction Tank" style="position: absolute; z-index: 2; top: 75px; left: 416px; width: 35px; height: 20px; background: transparent;">
            <div id="show_level1color" class="waterlevel">
                <img id="show_level1" src="../images/blank.gif" width="48" height="20" /></div>
        </div>
        <div id="water_level2" title="Suction Tank" style="position: absolute; z-index: 2; top:134px; left: 416px; width: 35px; height: 20px; background: transparent">
            <div id="show_level2color" class="waterlevel">
                <img id="show_level2" src="../images/blank.gif" width="48" height="20"></div>
        </div>
        <div id="water_level3" title="Suction Tank" style="position: absolute; z-index: 2; top:198px; left: 416px; width: 35px; height: 20px; background: transparent">
            <div id="show_level3color" class="waterlevel">
                <img id="show_level3" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level4" title="Suction Tank" style="position: absolute; z-index: 2; top: 263px; left: 416px; width: 35px; height: 20px; background: transparent">
            <div id="show_level4color" class="waterlevel">
                <img id="show_level4" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level5" title="Suction Tank" style="position: absolute; z-index: 2; top: 330px; left: 416px; width: 35px; height: 20px; background: transparent">
            <div id="show_level5color" class="waterlevel">
                <img id="show_level5" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level6" title="Suction Tank" style="position: absolute; z-index: 2; top: 394px; left: 416px; width: 35px; height: 20px; background: transparent">
            <div id="show_level6color" class="waterlevel">
                <img id="show_level6" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level7" title="Suction Tank" style="position: absolute; z-index: 2; top: 458px; left: 416px; width: 35px; height: 20px; background: transparent">
            <div id="show_level7color" class="waterlevel">
                <img id="show_level7" src="../images/blank.gif" width="48" height="10"></div>
        </div>

        <div id="water_level8" title="Suction Tank" style="position: absolute; z-index: 2; top: 522px; left: 416px; width: 35px; height: 20px; background: transparent">
            <div id="show_level8color" class="waterlevel">
                <img id="show_level8" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level9" title="Suction Tank" style="position: absolute; z-index: 2; top: 593px; left:416px; width: 35px; height: 20px; background: transparent">
            <div id="show_level9color" class="waterlevel">
                <img id="show_level9" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level10" title="Suction Tank" style="position: absolute; z-index: 2; top: 661px; left: 416px; width: 35px; height: 20px; background: transparent">
            <div id="show_level10color" class="waterlevel">
                <img id="show_level10" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level11" title="Suction Tank" style="position: absolute; z-index: 2; top: 134px; left: 570px; width: 35px; height: 20px; background: transparent">
            <div id="show_level11color" class="waterlevel">
                <img id="show_level11" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level12" title="Suction Tank" style="position: absolute; z-index: 2; top: 394px; left: 555px; width: 35px; height: 20px; background: transparent">
            <div id="show_level12color" class="waterlevel">
                <img id="show_level12" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level13" title="Suction Tank" style="position: absolute; z-index: 2; top: 522px; left: 555px; width: 35px; height: 20px; background: transparent">
            <div id="show_level13color" class="waterlevel">
                <img id="show_level13" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level14" title="Suction Tank" style="position: absolute; z-index: 2; top: 593px; left: 555px; width: 35px; height: 20px; background: transparent">
            <div id="show_level14color" class="waterlevel">
                <img id="show_level14" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level15" title="Suction Tank" style="position: absolute; z-index: 2; top: 134px; left: 716px; width: 35px; height: 20px; background: transparent">
            <div id="show_level15color" class="waterlevel">
                <img id="show_level15" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level16" title="Suction Tank" style="position: absolute; z-index: 2; top: 198px; left: 716px; width: 35px; height: 20px; background: transparent">
            <div id="show_level16color" class="waterlevel">
                <img id="show_level16" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level17" title="Suction Tank" style="position: absolute; z-index: 2; top: 263px; left: 716px; width: 35px; height: 20px; background: transparent">
            <div id="show_level17color" class="waterlevel">
                <img id="show_level17" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level18" title="Suction Tank" style="position: absolute; z-index: 2; top: 330px; left: 716px; width: 35px; height: 20px; background: transparent">
            <div id="show_level18color" class="waterlevel">
                <img id="show_level18" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level19" title="Suction Tank" style="position: absolute; z-index: 2; top: 394px; left: 716px; width: 35px; height: 20px; background: transparent">
            <div id="show_level19color" class="waterlevel">
                <img id="show_level19" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level20" title="Suction Tank" style="position: absolute; z-index: 2; top: 134px; left: 790px; width: 35px; height: 20px; background: transparent">
            <div id="show_level20color" class="waterlevel">
                <img id="show_level20" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level21" title="Suction Tank" style="position: absolute; z-index: 2; top: 198px; left:861px; width: 35px; height: 20px; background: transparent">
            <div id="show_level21color" class="waterlevel">
                <img id="show_level21" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level22" title="Suction Tank" style="position: absolute; z-index: 2; top: 330px; left: 861px; width: 35px; height: 20px; background: transparent">
            <div id="show_level22color" class="waterlevel">
                <img id="show_level22" src="../images/blank.gif" width="48" height="10"></div>
        </div>

           
        <div style="position: absolute; top: 75px; left: 423px; z-index: 2;">
            <div id="l_level2_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top: 134px; left: 423px; z-index: 2;">
            <div id="l_level3_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top: 198px; left: 423px; z-index: 2;">
            <div id="l_level4_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 263px; left: 423px; z-index: 2;">
            <div id="l_level5_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 330px; left: 423px; z-index: 2;">
            <div id="l_level6_value" class="black_box">???</div>
        </div>
           <div style="position: absolute; top: 394px; left:423px; z-index: 2;">
            <div id="l_level7_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 458px; left:423px; z-index: 2;">
            <div id="l_level8_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 522px; left: 423px; z-index: 2;">
            <div id="l_level9_value" class="black_box">???</div>
        </div>
         <div style="position: absolute; top: 593px; left: 423px; z-index: 2;">
            <div id="l_level10_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 661px; left:423px; z-index: 2;">
            <div id="l_level11_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 134px; left: 577px; z-index: 2;">
            <div id="l_level12_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 394px; left: 562px; z-index: 2;">
            <div id="l_level13_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 522px; left: 562px; z-index: 2;">
            <div id="l_level14_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 593px; left: 562px; z-index: 2;">
            <div id="l_level15_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 134px; left: 723px; z-index: 2;">
            <div id="l_level16_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 198px; left: 723px; z-index: 2;">
            <div id="l_level17_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 263px; left: 723px; z-index: 2;">
            <div id="l_level18_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 330px; left: 723px; z-index: 2;">
            <div id="l_level19_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 394px; left: 723px; z-index: 2;">
            <div id="l_level20_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 134px; left: 797px; z-index: 2;">
            <div id="l_level21_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 198px; left: 868px; z-index: 2;">
            <div id="l_level22_value" class="black_box">???</div>
        </div>
         <div style="position: absolute; top: 330px; left: 868px; z-index: 2;">
            <div id="l_level23_value" class="black_box">???</div>
        </div> 
                <div id="link" title="Loji Air Gadek 2" style="position: absolute; z-index: 2; top: 590px; left: 77px; width: 110px; height: 50px; background: transparent" onclick="showextend('LojoAirGadek03')">
