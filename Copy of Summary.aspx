...
<td width="359"><div align="center" id="divDateTime"><%=szparsestring(sequence, "/", 2) & szparsestring(sequence, "/", 1) & szparsestring(sequence, "/", 3)%></div></td>
</tr>
</table>
<p  style="margin-bottom: 15">
  <font size="1" face="Verdana" color="Red">
    ATTENTION : If flash component is not visible, click 
    <b><a href="http://www.macromedia.com/shockwave/download/triggerpages_mmcom/flash.html" target="_blank">
    here</a></b>
    to download the lastest Flash 7.0 
  </font>
</p>
        <%
		end select
