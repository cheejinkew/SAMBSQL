        ...
        ' If Not dist = "0" Then%>   
            <%  Dim distr
              ...
              objConn.open(strconn)
                Dim t
                t = "select at1.sequence, at1.siteid, at1.sitename, at1.alarmtype,st.sitedistrict  from telemetry_alert_message_table at1  left join telemetry_site_list_table st using(siteid) where at1.alarmtype in (select alarmtype from telemetry_rule_list_table where alert = true) and at1.sequence >='" & start_date & "' and at1.sequence <= '" & end_date & "' and st.siteid IN ("& strKontID &") order by st.sitedistrict, at1.sequence"
...
<td align="right" valign=top >
            ...
            <tr align="center"><td style="width: 45px; background-color: #465AE8; color: #FFFFFF">NN</td><td style="width: 50px;"><%=nn%></td></tr>
            </table>            
</td>
</tr></table>
   <% 
