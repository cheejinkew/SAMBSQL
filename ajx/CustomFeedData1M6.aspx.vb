...
Partial Class ajx_CustomFeedData1M6
    ...
    Public Sub getData()
        ...
        Try
            ...
            Query = "select est.siteid ,position ,dtimestamp,value,counter ,sevent ,st.sitename  from telemetry_equip_status_table_m6 est left outer join telemetry_site_list_table st on est.siteid =st.siteid  WHERE est.siteid = '" & strSiteID & "'  ORDER BY position ASC"
            ...
            While dr.Read()
                ...
                If (IsDBNull(dr("counter"))) Then
                    strCounter = "-"
                ElseIf (dr("counter").ToString().IndexOf(".") > -1) Then
                    strCounter = Convert.ToDouble(dr("counter")).ToString("0.00")
                Else
                    strCounter = dr("counter").ToString()
                End If
                ...
                strData = strData + strValue + "|" + strCounter + "|"
