...
<link rel=StyleSheet href="_objects.css" title="Contemporary">
	...
	<body bgcolor="#ffffff">
		<div id="BPH" style="Z-INDEX:1;LEFT:2px;POSITION:absolute;TOP:1px">
			...
			<!-- level -->
			<!--<div id="water_level1" style="Z-INDEX:2;BACKGROUND:none transparent scroll repeat 0% 0%;LEFT:42px;WIDTH:309px;POSITION:absolute;TOP:364px;HEIGHT:60px">
				<div id="show_level1color" class="waterlevel"><img id="show_level1" src="../images/blank.gif" width="309" height="10"></div>
			</div>
			<div id="water_level2" style="Z-INDEX:3;BACKGROUND:none transparent scroll repeat 0% 0%;LEFT:370px;WIDTH:309px;POSITION:absolute;TOP:364px;HEIGHT:60px">
			...
			<div style="Z-INDEX:3;LEFT:320px;CURSOR:pointer;POSITION:absolute;TOP:45px">
