<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PumpStatusReport.aspx.vb" Inherits="PumpStatusReport" %>
...
<body>
    ...
    <center>
     <div>
     <div style="color:#5F7AFC;font-size :large; font-family :Verdana ;" >Pump Running Report</div>
     <br />
     <br />
         ...
         <td width="16%">
          <font face="Verdana" size="1" color="#5F7AFC"><b>Site Name</b></font></td>
           <td width="3%">
            ...
            <tr>
         <td width="16%">
          <font face="Verdana" size="1" color="#5F7AFC"><b>Equipment</b></font></td>
           <td width="3%">
            <font face="Verdana" size="1" color="#5F7AFC"><b>:</b></font></td>
            <td width="87%">
             <asp:DropDownList ID="ddlEquipment" runat="server" CssClass="FormDropdown" >
               <asp:ListItem Value="4">Pump 1</asp:ListItem>
                <asp:ListItem Value="7">Pump 2</asp:ListItem>
                 <asp:ListItem Value="10">Pump 3</asp:ListItem>
             </asp:DropDownList>
            </td>
           </tr>    
           <%-- <tr>
