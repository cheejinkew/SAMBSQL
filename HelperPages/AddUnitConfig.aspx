    ...
    for i = 0 to 9
      if arryCheck(i) = "ON"
        ...
        'response.write(strSMS & "<br>")
            ...
            sqlSp = "insert into sms_outbox_table(destination,startdate,enddate,priority,smessage,network,assign,insertdate) values('" & strSimNo & "','" & strDTNow & "','" & _
                     strDTNow.AddDays(1) & "',2,'" & strSMS & "', 'None', '0', '" & strDTNow & "')"
...
'**************************************************************************************************
    ...
    if arryCheck(7) = "ON" and strLog = "Both" and strSMS1 <> "" then
        sqlSp = "insert into sms_outbox_table(destination,startdate,enddate,priority,smessage,network,assign,insertdate) values('" & strSimNo & "','" & strDTNow & "','" & _
                 strDTNow.AddDays(1) & "',2,'" & strSMS1 & "', 'None', '0', '" & strDTNow & "')"
    ...
    if arryCheck(8) = "ON" and strLog = "Both" and strSMS2 <> "" then
        sqlSp = "insert into sms_outbox_table(destination,startdate,enddate,priority,smessage,network,assign,insertdate) values('" & strSimNo & "','" & strDTNow & "','" & _
                 strDTNow.AddDays(1) & "',2,'" & strSMS2 & "', 'None', '0', '" & strDTNow & "')"
    ...
    if arryCheck(9) = "ON" and strLog = "Both" and strSMS3 <> "" then
        sqlSp = "insert into sms_outbox_table(destination,startdate,enddate,priority,smessage,network,assign,insertdate) values('" & strSimNo & "','" & strDTNow & "','" & _
                 strDTNow.AddDays(1) & "',2,'" & strSMS3 & "', 'None', '0', '" & strDTNow & "')"
