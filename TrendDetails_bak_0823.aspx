...
<%
    ...
    Dim aaa = Request.Form("txtEndDate")
    ...
    enddate = Request.Form("txtEndDate1") & " " & Request.Form("ddEndHour") & ":" & Request.Form("ddEndMinute") & ":00"
    ...
    ' ==========================================================================================================
	rsRecords.Open("select max from telemetry_equip_list_table where siteid='" & SiteID & "' and position =" & position ,objConn)
	if not rsRecords.EOF then
		get_MAX = rsrecords.fields("max").value
		'response.write("<p>" & rsrecords.fields("max").value & "</p>")
	end if
	rsRecords.close
	' ==========================================================================================================
