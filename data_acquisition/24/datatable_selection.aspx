...
<title>Telemetry 24 Hours SMS Data Acquisition Table</title>
</head>
...
<div style="position:absolute;top:8px;left:5px;" onclick="javascript:history.back();"><img border="0" src="../../images/report.jpg"></div>
...
<div class="report_select" id="report_select">
    <div class="title">
        Report:</div>
    <div class="left_arrow" onclick="return false;" style="visibility:hidden"><img src="../../images/leftwhite.gif"></div>
    <div class="box" id="report_type" >8:00AM-8:00AM</div>
    <div class="right_arrow" onclick="return false;" style="visibility:hidden"><img src="../../images/rightwhite.gif"></div>
</div>
