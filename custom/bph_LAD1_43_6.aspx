<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bph_LAD1_43_6.aspx.vb" Inherits="custom_LAD1_43_6" %>
...
<body  bgcolor="#0071bb">
    ...
    <div style ="background-image :url(imej/LAD1_43_6.png?r=199182392);height:745px;width :1050px;" >
    ...
    <div id="water_level1" title="Suction Tank" style="position:absolute;z-index:2;top:530px;left:170px;width:110px;;height:50px;background:transparent">
     ...
     <div id="water_level2" title="Suction Tank" style="position:absolute;z-index:2;top:454px;left:310px;width:110px;height:50px;background:transparent">
		<div id="show_level2color" class="waterlevel"><img id="show_level2" src="../images/blank.gif" width="62" height="10"></div>
	</div>
      <div id="water_level3" title="Suction Tank" style="position:absolute;z-index:2;top:503px;left:450px;width:110px;height:50px;background:transparent">
		<div id="show_level3color" class="waterlevel"><img id="show_level3" src="../images/blank.gif" width="62" height="10"></div>
	</div>
         <div id="water_level4" title="Suction Tank" style="position:absolute;z-index:2;top:529px;left:590px;width:110px;height:50px;background:transparent">
		<div id="show_level4color" class="waterlevel"><img id="show_level4" src="../images/blank.gif" width="62" height="10"></div>
	</div>
         <div id="water_level5" title="Suction Tank" style="position:absolute;z-index:2;top:416px;left:869px;width:110px;height:50px;background:transparent">
   ...
   <div style="position:absolute;top:474px;left:310px;z-index:2;"> 
      <div id="l_level3_value"  class="black_box">???</div> 
    </div>

      <div style="position:absolute;top:523px;left:450px;z-index:2;"> 
      <div id="l_level4_value"  class="black_box">???</div> 
    </div>
    <div style="position:absolute;top:548px;left:590px;z-index:2;"> 
      <div id="l_level5_value"  class="black_box">???</div> 
    </div> 
         <div style="position:absolute;top:436px;left:869px;z-index:2;"> 
