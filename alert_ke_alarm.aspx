          ...
          <%
             ...
             if arryControlDistrict(0) <> "ALL" then             
                  sqlRs.Open("select sequence, siteid, sitename, alarmtype " & _
                      ...
                      "                   where sitedistrict in (" & strControlDistrict & ")) and siteid not in ('8511','8512','8619','8620','8621','8643','8546') " & _
                             " and alarmtype in (select alarmtype from telemetry_rule_list_table where alert = true) " & _
                             "  order by sequence desc", objConn)
             else
                  sqlRs.Open("select sequence, siteid, sitename, alarmtype " & _
                             " from telemetry_alert_message_table " & _
                             " where siteid not in ('8511','8512','8619','8620','8621','8643','8546') and alarmtype in (select alarmtype from telemetry_rule_list_table where alert = true) " & _
                             "  order by sequence desc", objConn)
             end if
