<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SkimatikPaipLogiAirJus01.aspx.vb" Inherits="SkimatikPaipLogiAirJus01" %>
...
<body bgcolor="#0071bb">
 <form id="form1" runat="server">
        ...
        <div style="background-image: url(imej/SPLAJ-01.png?r=199182392); height: 745px; width: 1050px;">
        </div>

        <div id="water_level1" title="Suction Tank"   
            style="position: absolute; z-index: 2; top: 367px; left: 523px; width: 48px; height: 27px; background:transparent; margin-bottom: 3px;">
        ...
        <div id="water_level2" title="Suction Tank" 
            style="position: absolute; z-index: 2; top: 368px; left: 628px; width: 48px; height: 27px; background: transparent">
            <div id="show_level2color" class="waterlevel">
                <img id="show_level2" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level3" title="Suction Tank" style="position: absolute; z-index: 2; top:362px; left: 800px; width: 48px; height: 27px; background: transparent">
            <div id="show_level3color" class="waterlevel">
                <img id="show_level3" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level4" title="Suction Tank" style="position: absolute; z-index: 2; top: 429px; left: 800px; width: 48px; height: 27px; background: transparent">
            <div id="show_level4color" class="waterlevel">
                <img id="show_level4" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level5" title="Suction Tank" style="position: absolute; z-index: 2; top: 171px; left: 809px; width: 25px; height: 150px; background: transparent">
            <div id="show_level5color" class="waterlevel">
                <img id="show_level5" src="../images/blank.gif" width="25" height="10"></div>
        </div>
        
        <div style="position: absolute; top: 370px; left: 528px; z-index: 2; height: 13px; width: 20px;">
            <div id="l_level2_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top:371px; left: 637px; z-index: 2;">
            <div id="l_level3_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top: 363px; left: 807px; z-index: 2;">
            <div id="l_level4_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 434px; left:808px; z-index: 2;">
            <div id="l_level5_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 296px; left: 805px; z-index: 2;">
