...
<body bgcolor="#FFFFFF">
    ...
    <form name="formX" action="WaterLevelTrendAnalysis.aspx" method="POST">
        ...
        %>
        <form name="formX" action="WaterLevelTrendAnalysis.aspx" method="POST">
            <iframe id="frTest" name="frTest" style="width: 0px; height: 0px; position: absolute;
                top: 20; left: 40; display: inline; filter: shadow(color:gray,strength:10, direction:135);"
            ...
            <div align="center">
                <br>
                <p>
                    <img border="0" src="images/WTA.jpg">
                    <br>
                    <br>
                    <table border="0" cellspacing="1" width="80%">
                            ...
                            <td width="77%" colspan="2">
                                <font class="bodytxt">
                                    <input type="text" name="txtBeginDate" size="12" style="border-width: 1px; border-style: solid;
                                        ...
                                        height: 20" value="<%=strBeginDate%>" readonly>
                                </font><a href="<%=Action1%>;">
                        ...
                        <tr>
                            ...
                            <td width="77%" colspan="2">
                                <input type="text" name="txtEndDate" size="12" style="border-width: 1px; border-style: solid;
                                    border-color: #5F7AFC; font-family: Verdana; font-size: 10pt; color: #3952F9;
                                    height: 20" value="<%=strEndDate%>" readonly>
                                <a href="<%=Action2%>;">
                                    <img border="1" src="images/Calendar.jpg" width="19" height="14">
                                </a><font face="Verdana" size="1" color="#5F7AFC"><b>Hour:</b></font>
                            ...
                            <td width="77%" colspan="2">
                                <select size="1" name="ddSite1" class="FormDropdown1" onchange="javascript:HideShowSites(this.value, 1);">
                                    ...
                                    <%
                                       ...
                                       " and e.equiptype like '%LEVEL%' order by s.sitetype, s.sitename, e.desc", objConn)
                        ...
                        <tr>
                            <td width="20%">
                                <font face="Verdana" size="1" color="#5F7AFC"><b>5th Equipment</b></font></td>
                            <td width="3%">
                                <font face="Verdana" size="1" color="#5F7AFC"><b>:</b></font></td>
                            <td width="77%" colspan="2">
                                <div id="divSite5" style="visibility: <%=Visibiliti5%>;">
                                    <select size="1" name="ddSite5" class="FormDropdown1" onchange="javascript:HideShowSites(this.value, 5);">
                                        ...
                                        %>
                                        <option value="<%=intSiteID5%>,<%=intPosition5%>">
                                            <%=strSites5%>
                                        </option>
                                        <%
                        ...
                        <tr>
                            <td width="20%">
                                <font face="Verdana" size="1" color="#5F7AFC"><b>6th Equipment</b></font></td>
                            <td width="3%">
                                <font face="Verdana" size="1" color="#5F7AFC"><b>:</b></font></td>
                            <td width="77%" colspan="2">
                                <div id="divSite6" style="visibility: <%=Visibiliti6%>;">
                                    <select size="1" name="ddSite6" class="FormDropdown1" onchange="javascript:HideShowSites(this.value, 6);">
                                        ...
                                        %>
                                        <option value="<%=intSiteID6%>,<%=intPosition6%>">
                                            <%=strSites6%>
                                        </option>
                                        <%
                        ...
                        <tr>
                            <td width="20%">
                                <font face="Verdana" size="1" color="#5F7AFC"><b>7th Equipment</b></font></td>
                            <td width="3%">
                                <font face="Verdana" size="1" color="#5F7AFC"><b>:</b></font></td>
                            <td width="77%" colspan="2">
                                <div id="divSite7" style="visibility: <%=Visibiliti7%>;">
                                    <select size="1" name="ddSite7" class="FormDropdown1" onchange="javascript:HideShowSites(this.value, 7);">
                                        ...
                                        %>
                                        <option value="<%=intSiteID7%>,<%=intPosition7%>">
                                            <%=strSites7%>
                                        </option>
                                        <%
                        ...
                        <tr>
                            <td width="20%">
                                <font face="Verdana" size="1" color="#5F7AFC"><b>8th Equipment</b></font></td>
                            <td width="3%">
                                <font face="Verdana" size="1" color="#5F7AFC"><b>:</b></font></td>
                            <td width="77%" colspan="2">
                                <div id="divSite8" style="visibility: <%=Visibiliti8%>;">
                                    <select size="1" name="ddSite8" class="FormDropdown1">
                                        ...
                                        %>
                                        <option value="<%=intSiteID8%>,<%=intPosition8%>">
                                            <%=strSites8%>
                                        </option>
                                        <%
  ...
  function gotoSubmit(intStatus)
  {
    if (intStatus == "2")
   ...
   else
     {
      ...
      document.formX.action ="MelakaWTAnalysis.aspx";
      document.formX.submit();   
     }
  }
