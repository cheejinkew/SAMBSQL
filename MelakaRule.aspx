      ...
      <table border="0" cellpadding="0" cellspacing="0" width="98%">
        ...
        <tr>
          ...
          <td width="20%" height="30">
            <p align="right"><b><font size="1" face="Verdana"><a href="MelakaAddRule.aspx">Add New Rule</a></font></b></td>
        </tr>
      </table>
    </div>
    <center>
        <table border="0" width="98%" style="font-family: Verdana; font-size: 8pt">
          ...
          <%
             ...
             sqlRs.Open("Select * from telemetry_rule_list_table where siteid ='" & intSelectedSiteID & _
	...
	<tr bgcolor="#E7E8F8">
	  <%
          ...
          <td style="margin-left: 5">
            <a href="javascript:gotoUpdate('frmRule', 'txtRuleIDSiteName','<%=intRuleID%>,<%=strSiteName%>');">
             <%=strAlarmtype%>
            </a>
          </td>
     ...
     <input type="hidden" name="txtRuleIDSiteName" value="">
...
<script language="javascript">
  ...
  document.frmRule.ddSite.value="<%=intSelectedSiteID%>";

  
  if (strDisabled =="true")
  {
    document.frmRule.chkAllDelete.disabled = strDisabled;
  }
  else
  {
    document.frmRule.chkAllDelete.disabled = false;
  }


  function goSubmit()
  {
//    strSiteName = document.getElementById("ddSite")(document.frmRule.ddSite.selectedIndex).innerHTML;
    
	sel = document.frmRule.ddSite.selectedIndex;

	strSiteName = document.frmRule.ddSite.options[sel].text;	     
    
    document.frmRule.txtSiteName.value= strSiteName;
    document.frmRule.action="MelakaRule.aspx";
    document.frmRule.submit();
  }
