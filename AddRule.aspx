      ...
      <td>
        <div align="center">
          ...
          <table border="0" cellpadding="5" width="400" height="63">
            <tr>
              <td width="69" height="25"><b><font size="1" face="Verdana" color="#5373A2">District</font></b></td>
              ...
              <td width="280" height="26" colspan="2"><font color="#0B3D62">
                <select name="ddEquip" class="FormDropdown">
                  ...
                  <%
                    ...
                    objConn = new ADODB.Connection()
                    objConn.open(strConn)
                      sqlRs.Open("Select versionid, unitid, position, sdesc from telemetry_equip_list_table " & _
                               "where siteid ='" & intSelectedSiteID & "' and position not in (0,1)", objConn)
                    do while not sqlRs.EOF
                          strEquip = sqlRs("sdesc").value
