<%@ Page Language="C#" AutoEventWireup="true" CodeFile="overLowerreport.aspx.cs" Inherits="ReportManagement_overLowerreport"
    EnableEventValidation="false" %>

<html>
<head runat="server">
    <title>  Reservoir Low Level Report</title>
    <style type="text/css">
        .tableAlign
        {
            text-align: center;
...
<body>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="margin-top: 25px; text-align: right">
                                ...
                                <button id="btnExcel" value="EXCEL" class="button-blue"  onclick="ExcelReport()">EXCEL</button>
                            </div>
                        </td>
                    </tr>
                </table>
    ...
    <input type="hidden" id="title" name="title" runat ="server" value="Log Report" />
