            ...
            <tr>
              ...
              <td width="87%"><select size="1" name="ddPage" class="FormDropdown1" onchange="javascript:goPages(this.value)">
                  ...
                  <%--<option value="User">User Management</option>--%>
                    <option value="res">Reservoir Info</option>
                    <!-- <option value="rep">Reservoir Info Report</option>-->
                </select>
              </td>
            </tr>
            <tr>
...
<script language="javascript">
  ...
  function goPages(strPage)
  {
    if (strPage=="Dispatch")
    {
      document.frmAdmin.action="MelakaDispatch.aspx";
    }
    else if (strPage=="UnitConfig")
    {
      document.frmAdmin.action="MelakaUnitConfig.aspx";
    }
    else if (strPage=="Unit")
    {
      document.frmAdmin.action="MelakaUnit.aspx";
    }
    else if (strPage=="Rule")
    {
      document.frmAdmin.action="MelakaRule.aspx";
    }
    else if (strPage=="Site")
    {
      document.frmAdmin.action="MelakaSite.aspx";
    }
    else if (strPage=="Equip")
    {
      document.frmAdmin.action="MelakaEquipment.aspx";
    }
//    else if (strPage=="User")
//    {
//      document.frmAdmin.action="BesutUser.aspx";
//    }
    else if (strPage=="res")
    {
      document.frmAdmin.action="Melakareservoir.aspx";
    }
     else if (strPage=="rep")
    {
      document.frmAdmin.action="Melakareservoir.aspx";
