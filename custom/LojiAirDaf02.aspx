<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LojiAirDaf02.aspx.vb" Inherits="LojiAirDaf02" %>
...
<body bgcolor="#0071bb">
    <form id="form1" runat="server">
        ...
        <div style="background-image: url(imej/LojiAirDaf1-02.png?r=199182392); height: 745px; width: 1050px;">
        </div>

        <div id="water_level1" title="Suction Tank" style="position: absolute; z-index: 2; top: 341px; left: 133px; width: 48px; height: 27px; background: transparent;">
            <div id="show_level1color" class="waterlevel">
                <img id="show_level1" src="../images/blank.gif" width="48" height="20" /></div>
        </div>
        <div id="water_level2" title="Suction Tank" style="position: absolute; z-index: 2; top:539px; left: 191px; width: 48px; height: 27px; background: transparent">
            <div id="show_level2color" class="waterlevel">
                <img id="show_level2" src="../images/blank.gif" width="48" height="20"></div>
        </div>
        <div id="water_level3" title="Suction Tank" style="position: absolute; z-index: 2; top: 167px; left: 341px; width: 48px; height: 27px; background: transparent">
            <div id="show_level3color" class="waterlevel">
                <img id="show_level3" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level4" title="Suction Tank" style="position: absolute; z-index: 2; top: 221px; left: 341px; width: 48px; height: 27px; background: transparent">
            <div id="show_level4color" class="waterlevel">
                <img id="show_level4" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level5" title="Suction Tank" style="position: absolute; z-index: 2; top: 267px; left: 341px; width: 48px; height: 27px; background: transparent">
            <div id="show_level5color" class="waterlevel">
                <img id="show_level5" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level6" title="Suction Tank" style="position: absolute; z-index: 2; top: 361px; left: 341px; width: 48px; height: 27px; background: transparent">
            <div id="show_level6color" class="waterlevel">
                <img id="show_level6" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level7" title="Suction Tank" style="position: absolute; z-index: 2; top: 411px; left: 341px; width: 48px; height: 27px; background: transparent">
            <div id="show_level7color" class="waterlevel">
                <img id="show_level7" src="../images/blank.gif" width="48" height="10"></div>
        </div>

        <div id="water_level8" title="Suction Tank" style="position: absolute; z-index: 2; top: 461px; left: 341px; width: 48px; height: 27px; background: transparent">
            <div id="show_level8color" class="waterlevel">
                <img id="show_level8" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level9" title="Suction Tank" style="position: absolute; z-index: 2; top: 512px; left:341px; width: 48px; height: 27px; background: transparent">
            <div id="show_level9color" class="waterlevel">
                <img id="show_level9" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level10" title="Suction Tank" style="position: absolute; z-index: 2; top: 564px; left: 341px; width: 48px; height: 27px; background: transparent">
            <div id="show_level10color" class="waterlevel">
                <img id="show_level10" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level11" title="Suction Tank" style="position: absolute; z-index: 2; top: 167px; left: 434px; width: 48px; height: 27px; background: transparent">
            <div id="show_level11color" class="waterlevel">
                <img id="show_level11" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level12" title="Suction Tank" style="position: absolute; z-index: 2; top: 482px; left: 434px; width: 48px; height: 27px; background: transparent">
            <div id="show_level12color" class="waterlevel">
                <img id="show_level12" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level13" title="Suction Tank" style="position: absolute; z-index: 2; top: 411px; left: 516px; width: 48px; height: 27px; background: transparent">
            <div id="show_level13color" class="waterlevel">
                <img id="show_level13" src="../images/blank.gif" width="48" height="10"></div>
        </div>
            <div id="water_level14" title="Suction Tank" style="position: absolute; z-index: 2; top: 169px; left: 573px; width: 25px; height: 26px; background: transparent">
            <div id="show_level14color" class="waterlevel">
                <img id="show_level14" src="../images/blank.gif" width="25" height="10"></div>
        </div>
    
           
        <div style="position: absolute; top: 341px; left: 140px; z-index: 2;">
            <div id="l_level2_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top: 539px; left: 198px; z-index: 2;">
            <div id="l_level3_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top: 167px; left: 348px; z-index: 2;">
            <div id="l_level4_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 221px; left: 348px; z-index: 2;">
            <div id="l_level5_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 267px; left: 348px; z-index: 2;">
            <div id="l_level6_value" class="black_box">???</div>
        </div>
           <div style="position: absolute; top: 361px; left:348px; z-index: 2;">
            <div id="l_level7_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 411px; left:348px; z-index: 2;">
            <div id="l_level8_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 461px; left: 348px; z-index: 2;">
            <div id="l_level9_value" class="black_box">???</div>
        </div>
         <div style="position: absolute; top:512px; left: 348px; z-index: 2;">
            <div id="l_level10_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 564px; left:348px; z-index: 2;">
            <div id="l_level11_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 167px; left: 441px; z-index: 2;">
            <div id="l_level12_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 482px; left: 441px; z-index: 2;">
            <div id="l_level13_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 411px; left: 525px; z-index: 2;">
            <div id="l_level14_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 167px; left: 569px; z-index: 2;">
            <div id="l_level15_value" class="black_box">???</div>
        </div>
          
                  <div id="link" title="Loji Air Gadek 2" style="position: absolute; z-index: 2; top: 590px; left: 877px; width: 110px; height: 50px; background: transparent" onclick="showextend('LojiAirDaf03')">
             <img id="next" src="../images/next2.png" width="48" height="30"/> 
         </div>
                <div id="link" title="Loji Air Gadek 2" style="position: absolute; z-index: 2; top: 590px; left: 77px; width: 110px; height: 50px; background: transparent" onclick="showextend('LojiAirDaf01')">
