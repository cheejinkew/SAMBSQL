...
<script language="VB" runat="server">
  ...
  Sub Page_Load(Source As Object, E As EventArgs) 
    ...
    if strAlert="-1" then
      objComm = new OdbcCommand ("Select sequence, alarm from telemetry_alarm_history_table " & _
    ...
    sbrHTML = new StringBuilder()
     ...
     do while sqlRs.Read()
       ...
       sbrHTML.Append("<TR><TD align='left'>" & sqlRs.GetValue(0).ToString() & "</TD><TD>" & _
		      sqlRs.GetValue(1).ToString() & "</TD></TR>")
     loop
     sqlRs.Close()
     ...
     do while sqlRs1.Read()
       objComm2 = new OdbcCommand ("select count(alarm) as AlarmCount from telemetry_alarm_history_table " & _
                                   " where siteid ='" & strSite  & "' " & _
                                   " and sequence >= '" & strBeginDateTime & "' and sequence <= '" & strEndDateTime & "'" & _
                                   " and alarm ='" & sqlRs1.GetValue(0).ToString()  & "'", objConn)
