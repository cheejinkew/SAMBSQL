...
<script runat="server">
	...
	Public StrDate, StrDate1, strSiteId, selectedDistrict, strBeginDate, strLastDate, strBeginDateTime, strEndDateTime
	Dim equipname
	Dim position
	Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
		...
		SelectedDistrict = Request.QueryString("selectedDistrict")
...
<a href="javascript:print();">&nbsp;<img src="images/print.jpg" alt="" /></a>--%>
   ...
   <table border="0" cellspacing="0" cellpadding="0" style="position: absolute; font-family:Verdana; font-size:0.20in; width:90%; height:30%; color:white; font-weight:bolder ; left: 53px; top: 10px;">
      ...
      <td style=" font-size:0.20in; width: 30%; background-color:#aab9fd;"> 
         <p align="center">  
         <%=equipname%> For : <%=Request("SelectedDistrict")%> District   
        </p>
       </td>
    </tr> 
    <tr align="center">
   ...
   <%  If equipname = "Water Level Trending" Then%>
           ...
           <tr align="center" >
			   <td style="font-weight: bold;width:50px; height: 17px;">No.</td>	
			   <td style="font-weight: bold; height: 17px; width: 80px;">Site ID</td>
			   <td style="font-weight: bold; height: 17px; width: 120px;">Site Name</td>
			   <td style="font-weight: bold;width:100px; height: 17px;">Date & Time</td>
			   <td style="font-weight: bold; height: 17px; width: 80px;">Average Level (M)</td>
			   <td style="font-weight: bold; height: 17px; width: 80px;">Max Level (M)</td>
			   <td style="font-weight: bold; height: 17px; width: 80px;">Min Level (M)</td>
			   <td style="font-weight: bold; height: 17px; width: 80px;">Median Level (M)</td>
           </tr>
               <%
				   ...
				   Dim str1 As String = "select siteid from telemetry_site_list_table where sitedistrict = '" & selectedDistrict & "'"
				   objConn.Open()
				   ...
				   For Each item As String In aList
					   ...
					   Do While strLastDate <= String.Format("{0:yyyy/MM/dd HH:mm:ss}", Date.Parse(strEndDateTime))
						   ...
						   'While (dr.Read())
						   Dim cmd2 As New SqlCommand(str2, objConn)
						   ...
						   While (reader.Read())
							   ...
							   If (checkSiteId = reader(0)) Then
								   Response.Write("<tr><td align=center><font color='Black'> </td>")
								   Response.Write("<td align=center><font color='Black'> </td>")
								   Response.Write("<td align=center><font color='Black'> </td>")
							   Else
							   ...
							   Response.Write("<td align=center><font color='Black'>" & reader(3) & "</td>")
							   Response.Write("<td align=center><font color='Black'>" & reader(4) & "</td>")
							   Response.Write("<td align=center><font color=Black>" & reader(5) & "</font></td> </tr>")
