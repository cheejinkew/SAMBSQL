<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bph_LAG_43_8.aspx.vb" Inherits="bph_LAG_43_8" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetData() {
           ...
           var url_15 = "../ajx/CustomFeedData1.aspx?ID=" + SiteID_13;
           ...
           xmlhttp_14.send();
           xmlhttp_15.open("GET", url_14, true);
           xmlhttp_15.send();
...
<body bgcolor="#0071bb">
    <form id="form1" runat="server">
        ...
        <div style="background-image: url(imej/LAG_43_8.png?r=199182392); height: 745px; width: 1050px;">
        </div>

        <div id="water_level1" title="Suction Tank" style="position: absolute; z-index: 2; top: 594px; left: 122px; width: 48px; height: 27px; background: transparent;">
            <div id="show_level1color" class="waterlevel">
                <img id="show_level1" src="../images/blank.gif" width="48" height="20" /></div>
        </div>
        <div id="water_level2" title="Suction Tank" style="position: absolute; z-index: 2; top:498px; left: 210px; width: 48px; height: 27px; background: transparent">
            <div id="show_level2color" class="waterlevel">
                <img id="show_level2" src="../images/blank.gif" width="48" height="20"></div>
        </div>
        <div id="water_level3" title="Suction Tank" style="position: absolute; z-index: 2; top: 449px; left: 306px; width: 48px; height: 27px; background: transparent">
            <div id="show_level3color" class="waterlevel">
                <img id="show_level3" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level4" title="Suction Tank" style="position: absolute; z-index: 2; top: 550px; left: 306px; width: 48px; height: 27px; background: transparent">
            <div id="show_level4color" class="waterlevel">
                <img id="show_level4" src="../images/blank.gif" width="48" height="10"></div>
        </div>
        <div id="water_level5" title="Suction Tank" style="position: absolute; z-index: 2; top: 532px; left: 413px; width: 48px; height: 27px; background: transparent">
            <div id="show_level5color" class="waterlevel">
                <img id="show_level5" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level6" title="Suction Tank" style="position: absolute; z-index: 2; top: 568px; left: 413px; width: 48px; height: 27px; background: transparent">
            <div id="show_level6color" class="waterlevel">
                <img id="show_level6" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level7" title="Suction Tank" style="position: absolute; z-index: 2; top: 619px; left: 514px; width: 48px; height: 27px; background: transparent">
            <div id="show_level7color" class="waterlevel">
                <img id="show_level7" src="../images/blank.gif" width="48" height="10"></div>
        </div> 
        <div id="water_level8" title="Suction Tank" style="position: absolute; z-index: 2; top: 501px; left: 605px; width: 48px; height: 27px; background: transparent">
            <div id="show_level8color" class="waterlevel">
                <img id="show_level8" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level9" title="Suction Tank" style="position: absolute; z-index: 2; top: 524px; left:695px; width: 48px; height: 27px; background: transparent">
            <div id="show_level9color" class="waterlevel">
                <img id="show_level9" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level10" title="Suction Tank" style="position: absolute; z-index: 2; top: 524px; left: 755px; width: 48px; height: 27px; background: transparent">
            <div id="show_level10color" class="waterlevel">
                <img id="show_level10" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level11" title="Suction Tank" style="position: absolute; z-index: 2; top: 579px; left: 695px; width: 48px; height: 27px; background: transparent">
            <div id="show_level11color" class="waterlevel">
                <img id="show_level11" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level12" title="Suction Tank" style="position: absolute; z-index: 2; top: 579px; left: 755px; width: 48px; height: 27px; background: transparent">
            <div id="show_level12color" class="waterlevel">
                <img id="show_level12" src="../images/blank.gif" width="48" height="10"></div>
        </div>
          <div id="water_level13" title="Suction Tank" style="position: absolute; z-index: 2; top: 540px; left: 850px; width: 48px; height: 27px; background: transparent">
            <div id="show_level13color" class="waterlevel">
                <img id="show_level13" src="../images/blank.gif" width="48" height="10"></div>
        </div>
            <div id="water_level14" title="Suction Tank" style="position: absolute; z-index: 2; top: 606px; left: 850px; width: 48px; height: 26px; background: transparent">
            <div id="show_level14color" class="waterlevel">
                <img id="show_level14" src="../images/blank.gif" width="48" height="10"></div>
        </div>
     <div id="water_level15" title="Suction Tank" style="position: absolute; z-index: 2; top: 550px; left: 945px; width: 48px; height: 26px; background: transparent">
            <div id="show_level15color" class="waterlevel">
                <img id="show_level15" src="../images/blank.gif" width="48" height="10"></div>
        </div>
    
           
        <div style="position: absolute; top: 594px; left: 130px; z-index: 2;">
            <div id="l_level2_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top: 498px; left: 218px; z-index: 2;">
            <div id="l_level3_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top: 449px; left: 316px; z-index: 2;">
            <div id="l_level4_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 550px; left: 316px; z-index: 2;">
            <div id="l_level5_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 532px; left: 423px; z-index: 2;">
            <div id="l_level6_value" class="black_box">???</div>
        </div>
           <div style="position: absolute; top: 568px; left:423px; z-index: 2;">
            <div id="l_level7_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 619px; left:524px; z-index: 2;">
            <div id="l_level8_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 501px; left: 615px; z-index: 2;">
            <div id="l_level9_value" class="black_box">???</div>
        </div>
         <div style="position: absolute; top:524px; left: 705px; z-index: 2;">
            <div id="l_level10_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 524px; left:765px; z-index: 2;">
            <div id="l_level11_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 579px; left: 705px; z-index: 2;">
            <div id="l_level12_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 579px; left:765px; z-index: 2;">
            <div id="l_level13_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 540px; left: 860px; z-index: 2;">
            <div id="l_level14_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 606px; left: 860px; z-index: 2;">
            <div id="l_level15_value" class="black_box">???</div>
        </div>
            <div style="position: absolute; top: 550px; left: 955px; z-index: 2;">
