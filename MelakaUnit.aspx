      ...
      <table border="0" cellpadding="0" cellspacing="0" width="70%">
        ...
        <tr>
          ...
          <td width="39%" height="30">
            ...
            <option value="0,0" selected="selected"> - Select User -</option>
            <%---
            ...
            ---%>
            <option value="1,Melaka">PemajuAdmin</option>
            <option value="2,Melaka">Pemaju</option>
            </select>
          ...
          <td width="50%" height="30">
            <p align="right"><b><font size="1" face="Verdana"><a href="MelakaAddUnit.aspx?user=<%=strUIDCltDistr%>">Add New Unit</a></font></b></td>
        </tr>
      </table>
    </div>
    <center>
...
<script language="javascript">
  ...
  function goSubmit()
  {
    document.frmUnit.action="MelakaUnit.aspx";
