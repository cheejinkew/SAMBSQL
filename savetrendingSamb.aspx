<%@ Page Language="VB" AutoEventWireup="false" CodeFile="savetrendingSamb.aspx.vb"
    Inherits="savetrendingSamb" %>
                        ...
                        <table style="font-family: Verdana; font-size: 11px;">
                            <tr>
                                <td style="height: 20px; background-color: #465ae8;" align="left">
                                    <b style="color: White;">&nbsp;Saving Trending Chart &nbsp;:</b>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 420px; border: solid 1px #3952F9;">
                                    <table style="width: 483px;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <b style="color: #5f7afc;">District</b>
                                                </td>
                                                <td>
                                                    <b style="color: #5f7afc;">:</b>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="ddlDistrict" runat="server" Width="200px" Font-Size="12px"
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <b style="color: #5f7afc;">Site Type</b>
                                                </td>
                                                <td>
                                                    <b style="color: #5f7afc;">:</b>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="ddlSiteType" runat="server" Width="200px" Font-Size="12px"
                                                        Font-Names="verdana" AutoPostBack="True">
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <b style="color: #5f7afc;">Site</b>
                                                </td>
                                                <td>
                                                    <b style="color: #5f7afc;">:</b>
                                                </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="ddlSite" runat="server" Width="200px" Font-Size="12px" Font-Names="verdana"
                                                        AutoPostBack="True">
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <b style="color: #5f7afc;">Equipment</b>
                                                </td>
                                                <td>
                                                    <b style="color: #5f7afc;">:</b>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <b style="color: #5f7afc;">Equipment Desc</b>
                                                </td>
                                                <td>
                                                    <b style="color: #5f7afc;">:</b>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <b style="color: #5f7afc;">Position</b>
                                                </td>
                                                <td>
                                                    <b style="color: #5f7afc;">:</b>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <b style="color: #5f7afc;">Criteria</b>
                                                </td>
                                                <td>
                                                    <b style="color: #5f7afc;">:</b>
                                                </td>
                                                <td align="left">
                                                    <!--  <asp:RadioButton ID="radFirstTime" runat="server" Text="12am - 8am" 
                                                            Font-Bold="True" GroupName="aaa"></asp:RadioButton>
                                                        <asp:RadioButton ID="radSecondTime" runat="server" Text="8am - 4pm" 
                                                            Font-Bold="True" GroupName="aaa"></asp:RadioButton>
                                                         <asp:RadioButton ID="radThirdTime" runat="server" Text="4pm - 12am" 
                                                            Font-Bold="True" GroupName="aaa"></asp:RadioButton>
                                                          <asp:RadioButton ID="radAll" runat="server" Text="All" Font-Bold="True" 
                                                            GroupName="aaa"></asp:RadioButton>-->
                                                    <asp:CheckBox ID="chkFirstTime" runat="server" Font-Bold="True" Text="12am - 8am" />
                                                    <asp:CheckBox ID="chkSecondTime" runat="server" Font-Bold="True" Text="8am - 4pm" />
                                                    <asp:CheckBox ID="chkThirdTime" runat="server" Font-Bold="True" Text="4pm - 12am" />
                                                    <asp:CheckBox ID="chkAll" runat="server" Font-Bold="True" Text="All" />
                                                    &nbsp;
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                                    <b style="color: #5f7afc;">All Criteria</b>
                                                </td>
                                                <td>
                                                    <b style="color: #5f7afc;">:</b>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" align="right">
                                                    ...
                                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="images/Submit_s.jpg"
                                                        ToolTip="Submit" Style="height: 18px; margin-top: 0px;" />
