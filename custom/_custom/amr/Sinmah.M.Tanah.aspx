...
<link rel=StyleSheet href="_objects.css" title="Contemporary">
		...
		<div id="BPH" style="Z-INDEX:1;LEFT:2px;POSITION:absolute;TOP:1px">
			<img src="img/Sinmah.M.Tanah.gif">
<!--			<div onclick="window.location='_jkolam_3.aspx';" class="pointer" style="Z-INDEX:2;LEFT:4px;POSITION:absolute;TOP:383px"><img src="../images/left.jpg"></div>-->
			...
			<!-- level -->
			<!--<div id="water_level1" style="Z-INDEX:2;BACKGROUND:none transparent scroll repeat 0% 0%;LEFT:30px;WIDTH:309px;POSITION:absolute;TOP:282px;HEIGHT:60px">
				<div id="show_level1color" class="waterlevel"><img id="show_level1" src="../images/blank.gif" width="309" height="10"></div>
			</div>
			<!--<div id="water_level2" style="Z-INDEX:3;BACKGROUND:none transparent scroll repeat 0% 0%;LEFT:350px;WIDTH:309px;POSITION:absolute;TOP:282px;HEIGHT:60px">
			...
			<div style="Z-INDEX:3;LEFT:410px;CURSOR:pointer;POSITION:absolute;TOP:55px">
