...
{
  var strLayout = "<style>.SelectStyle{font-family:verdana;}</style><div id='divTWCalendar' style='position:absolute; left:-400; top:100; Z-INDEX: 5;filter: alpha(opacity=90);border-width: 1px;border-style: solid;border-color: #4960F8;'>" +
                  "  <table border='0' cellpadding='3' cols='7' width='200' bgcolor='#FFFFFF' style='border: 1 solid #3952F9'>" +
  ...
  for (var intI = intCurrentYear - 8; intI < intCurrentYear + 2; intI++)
  {
...
//  eval("document.getElementById('" + txtTargetDateField + "').value = '" + strSelectedDate + "'");
