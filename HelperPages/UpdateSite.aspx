...
<%
  ...
  sqlSp = "update telemetry_site_list_table set sitename='" & strSiteName & _
          "', unitid = '" & intUnitID & "', associate='" & strAsscID & _
          "', lat = " & intLat & ", lon=" & intLon & _
          ", comment ='" & strComment & "', address='" & strAddress & "' " & _
