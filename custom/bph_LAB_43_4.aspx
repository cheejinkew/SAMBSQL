<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bph_LAB_43_4.aspx.vb" Inherits="custom_bph_LAB_43_4" %>
   ...
   $(document).ready(function () {
        ...
        function Fill_Res_Data(data, sno) {
            ...
            if (sno == 1) {
                ...
                $("#rtu_stat5_title").html(arrdata[0]);
                $("#rtu_stat5_tag").html(arrdata[3]);
                $("#rtu_stat5_sitename").html(arrdata[4]);
                //Water Level 2
...
<body  bgcolor="#0071bb">
    ...
    <div style ="background-image :url(imej/LAD1_43_4.png?r=199182392);height:745px;width :1000px;" >
    
    </div>
    
    <div id="water_level1" title="Suction Tank" style="position:absolute;z-index:2;top:529px;left:170px;width:110px;;height:50px;background:transparent">
		<div id="show_level1color" class="waterlevel"><img id="show_level1" src="../images/blank.gif" width="62" height="10"></div>
	</div>
     <div id="water_level2" title="Suction Tank" style="position:absolute;z-index:2;top:473px;left:403px;width:110px;height:50px;background:transparent">
		<div id="show_level2color" class="waterlevel"><img id="show_level2" src="../images/blank.gif" width="62" height="10"></div>
	</div>
      <div id="water_level3" title="Suction Tank" style="position:absolute;z-index:2;top:491px;left:635px;width:110px;height:50px;background:transparent">
		<div id="show_level3color" class="waterlevel"><img id="show_level3" src="../images/blank.gif" width="62" height="10"></div>
	</div>
         <div id="water_level4" title="Suction Tank" style="position:absolute;z-index:2;top:497px;left:868px;width:110px;height:50px;background:transparent">
   ...
   <div style="position:absolute;top:493px;left:403px;z-index:2;"> 
      <div id="l_level3_value"  class="black_box">???</div> 
    </div>

      <div style="position:absolute;top:511px;left:636px;z-index:2;"> 
      <div id="l_level4_value"  class="black_box">???</div> 
    </div>
    <div style="position:absolute;top:517px;left:866px;z-index:2;"> 
