<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DispacthHistoryReport.aspx.vb" Inherits="samb_SambSql_LogReport" %>
     ...
     <td align="center" class="style24">                 
         <asp:GridView ID="gvLogReport" runat="server" AutoGenerateColumns="False" 
             ...
             <Columns>
                 ...
                 <asp:BoundField HeaderText="Receiver" DataField ="sname">
                 <HeaderStyle BackColor="#4D90FE" />
                 <ItemStyle ForeColor="Black "   HorizontalAlign="Center"/>
                 </asp:BoundField>
