...
<%
    ...
    Dim strSQL = "SELECT max(value) AS nMax FROM telemetry_log_table_m6 where siteid='" & _
    ...
    Do While strLastDate <= String.Format("{0:yyyy/MM/dd HH:mm:ss}", Date.Parse(strEndDateTime))
        ...
        Dim txt = "select top 1 value, dtimestamp, position from telemetry_log_table_M6 where siteid='" & _
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2" align="center">
                    <a href="Trendingm6.aspx?siteid=<%=request("siteid")%>&Pos=<%=Request("position")%>">
