...
<%
	...
	dim bgcolor = "#ADD8E6"
	dim oricolor = "#ADD8E6"
    Dim siteid() As String = {"8631", "8526", "8588", "8629", "ALOR GAJAH LOW LEVEL", "TANGKI R/AWAM PULAU SEBANG", "TANGKI TMN DIMENSI", "TANGKI TMN SEBANG GEMILANG", "8592", "KOLAM INDUSTRI RUMBIA", "8529", "8557", "8563", "8614", "8591", "8586", "KAUSAR", "BKT BUSUK", "8555", "8587","8613", "TANGKI SOLOK MENGGONG", "8558", "TANGKI TMN KEBAYA", "8556", "TANGKI BANDAR BARU MASJID TANAH", "8547"}
%>
<html>
<head>
...
<body>
	<div id="header">MIMIC05: Loji Gadek</div>
	<div class="mainbox">	
		...
		<div class="Vline" style="height:965px;top:255px;left:225px;"></div>
		...
		<div class="Vline" style="height:865px;top:40px;left:475px;"></div>
		<div class="Vline" style="height:550px;top:985px;left:475px;"></div>
		<div class="childbox" style="left:500px;">
			...
			<div class="lagenda" style="position:absolute;top:545px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(9)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(9)%></div>
				<div class="lineDIV"><div id="<%=siteid(9)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(9)%>_status" class="textbox"></div></div>
				
			</div>
			<div class="lagenda" style="position:absolute;top:635px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(10)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(10)%></div>
				<div class="lineDIV"><div id="<%=siteid(10)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(10)%>_status" class="textbox"></div></div>
				<div class="right" style="top:29px;left:199px;"></div>
			</div>
			<div class="lagenda" style="position:absolute;top:770px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(11)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(11)%></div>
				<div class="lineDIV"><div id="<%=siteid(11)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(11)%>_status" class="textbox"></div></div>
				<div class="right" style="top:29px;left:199px;"></div>
			</div>
			<div class="lagenda" style="position:absolute;top:860px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(12)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(12)%></div>
				<div class="lineDIV"><div id="<%=siteid(12)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(12)%>_status" class="textbox"></div></div>
			</div>
			<div class="lagenda" style="position:absolute;top:950px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(13)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(13)%></div>
				<div class="lineDIV"><div id="<%=siteid(13)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(13)%>_status" class="textbox"></div></div>
			</div>
			<div class="lagenda" style="position:absolute;top:1040px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(14)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(14)%></div>
				<div class="lineDIV"><div id="<%=siteid(14)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(14)%>_status" class="textbox"></div></div>
			</div>
			<div class="lagenda" style="position:absolute;top:1130px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(15)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(15)%></div>
				<div class="lineDIV"><div id="<%=siteid(15)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(15)%>_status" class="textbox"></div></div>
			</div>
			<div class="lagenda" style="position:absolute;top:1220px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(16)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(16)%></div>
				<div class="lineDIV"><div id="<%=siteid(16)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(16)%>_status" class="textbox"></div></div>				
			</div>
			<div class="lagenda" style="position:absolute;top:1310px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(17)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(17)%></div>
				<div class="lineDIV"><div id="<%=siteid(17)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(17)%>_status" class="textbox"></div></div>
				<div class="right" style="top:29px;left:199px;"></div>
			</div>
			<div class="lagenda" style="position:absolute;top:1400px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(18)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(18)%></div>
				<div class="lineDIV"><div id="<%=siteid(18)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(18)%>_status" class="textbox"></div></div>
			</div>
			<div class="lagenda" style="position:absolute;top:1490px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(19)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(19)%></div>
				<div class="lineDIV"><div id="<%=siteid(19)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(19)%>_status" class="textbox"></div></div>
			</div>
		</div>
		<div class="Vline" style="height:100px;top:760px;left:725px;"></div>
		<div class="Vline" style="height:100px;top:1300px;left:725px;"></div>
		<div class="childbox" style="left:750px;">
			<div class="lagenda" style="position:absolute;top:635px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(20)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(20)%></div>
				<div class="lineDIV"><div id="<%=siteid(20)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(20)%>_status" class="textbox"></div></div>
				<div class="right" style="top:29px;left:199px;"></div>
			</div>
			<div class="lagenda" style="position:absolute;top:725px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(21)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(21)%></div>
				<div class="lineDIV"><div id="<%=siteid(21)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(21)%>_status" class="textbox"></div></div>
			</div>
			<div class="lagenda" style="position:absolute;top:815px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(22)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(22)%></div>
				<div class="lineDIV"><div id="<%=siteid(22)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(22)%>_status" class="textbox"></div></div>
			</div>
			<div class="lagenda" style="position:absolute;top:1265px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(23)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(23)%></div>
				<div class="lineDIV"><div id="<%=siteid(23)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(23)%>_status" class="textbox"></div></div>
			</div>
			<div class="lagenda" style="position:absolute;top:1355px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(24)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(24)%></div>
				<div class="lineDIV"><div id="<%=siteid(24)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(24)%>_status" class="textbox"></div></div>
			</div>
		</div>		
		<div class="Vline" style="height:100px;top:625px;left:975px;"></div>
		<div class="childbox" style="left:1000px;">
			<div class="lagenda" style="position:absolute;top:590px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(25)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(25)%></div>
				<div class="lineDIV"><div id="<%=siteid(25)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(25)%>_status" class="textbox"></div></div>				
			</div>
			<div class="lagenda" style="position:absolute;top:680px;left:2px;">
				<div class="right" style="top:29px;left:-25px;"></div>
				<div id="<%=siteid(26)%>_sitename" class="titlebox" style="background:<%=oricolor%>"><%=siteid(26)%></div>
				<div class="lineDIV"><div id="<%=siteid(26)%>_timestamp" class="textbox"></div></div>
				<div class="lineDIV"><div id="<%=siteid(26)%>_status" class="textbox"></div></div>				
			</div>
		</div>
	</div>
