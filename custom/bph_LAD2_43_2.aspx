<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bph_LAD2_43_2.aspx.vb" Inherits="custom_LAD2_43_2" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetData() {
           ...
           var SiteID_18 = '<%=strsiteid18%>';
           var SiteID_19 = '<%=strsiteid19%>';
           var SiteID_20 = '<%=strsiteid20%>';
           ...
           var url_19 = "../ajx/CustomFeedData1.aspx?ID=" + SiteID_18;
           var url_20 = "../ajx/CustomFeedData1.aspx?ID=" + SiteID_19;
           var url_21 = "../ajx/CustomFeedData1.aspx?ID=" + SiteID_20;
           ...
           if (window.XMLHttpRequest) {// code for IE7+, Firefox, Chrome, Opera, Safari
               ...
               xmlhttp_19 = new XMLHttpRequest();
               xmlhttp_20 = new XMLHttpRequest();
               xmlhttp_21 = new XMLHttpRequest();
           }
               ...
               xmlhttp_19 = new ActiveXObject("Microsoft.XMLHTTP");
               xmlhttp_20 = new ActiveXObject("Microsoft.XMLHTTP");
               xmlhttp_21 = new ActiveXObject("Microsoft.XMLHTTP");
           ...
           xmlhttp_19.onreadystatechange = function () {
               if (xmlhttp_19.readyState == 4 && xmlhttp_19.status == 200) {
                   var data = xmlhttp_19.responseText;
                   Fill_Res_Data(data, 19);
               }
           }
           xmlhttp_20.onreadystatechange = function () {
               if (xmlhttp_20.readyState == 4 && xmlhttp_20.status == 200) {
                   var data = xmlhttp_20.responseText;
                   Fill_Res_Data(data, 20);
               }
           }
           xmlhttp_21.onreadystatechange = function () {
               if (xmlhttp_21.readyState == 4 && xmlhttp_21.status == 200) {
                   var data = xmlhttp_21.responseText;
                   Fill_Res_Data(data, 21);
               }
           }
           ...
           xmlhttp_19.open("GET", url_19, true);
           xmlhttp_19.send();

           xmlhttp_20.open("GET", url_20, true);
           xmlhttp_20.send();

           xmlhttp_21.open("GET", url_21, true);
           xmlhttp_21.send();
...
<body bgcolor="#0071bb">
    <form id="form1" runat="server">
        ...
        <div style="background-image: url(imej/LAD2_43_2.png?r=199182392); height: 745px; width: 1050px;">
        </div>

        <div id="water_level1" title="Suction Tank" style="position: absolute; z-index: 2; top: 538px; left: 135px; width: 35px; height: 20px; background: transparent;">
            <div id="show_level1color" class="waterlevel">
                <img id="show_level1" src="../images/blank.gif" width="35" height="20" /></div>
        </div>
        <div id="water_level2" title="Suction Tank" style="position: absolute; z-index: 2; top:522px; left: 192px; width: 35px; height: 20px; background: transparent">
            <div id="show_level2color" class="waterlevel">
                <img id="show_level2" src="../images/blank.gif" width="35" height="20"></div>
        </div>
        <div id="water_level3" title="Suction Tank" style="position: absolute; z-index: 2; top: 522px; left: 231px; width: 35px; height: 20px; background: transparent">
            <div id="show_level3color" class="waterlevel">
                <img id="show_level3" src="../images/blank.gif" width="35" height="10"></div>
        </div>
        <div id="water_level4" title="Suction Tank" style="position: absolute; z-index: 2; top: 570px; left: 292px; width: 35px; height: 20px; background: transparent">
            <div id="show_level4color" class="waterlevel">
                <img id="show_level4" src="../images/blank.gif" width="35" height="10"></div>
        </div>
        <div id="water_level5" title="Suction Tank" style="position: absolute; z-index: 2; top: 570px; left: 330px; width: 35px; height: 20px; background: transparent">
            <div id="show_level5color" class="waterlevel">
                <img id="show_level5" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level6" title="Suction Tank" style="position: absolute; z-index: 2; top: 555px; left: 392px; width: 35px; height: 20px; background: transparent">
            <div id="show_level6color" class="waterlevel">
                <img id="show_level6" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level7" title="Suction Tank" style="position: absolute; z-index: 2; top: 543px; left: 450px; width: 35px; height: 20px; background: transparent">
            <div id="show_level7color" class="waterlevel">
                <img id="show_level7" src="../images/blank.gif" width="35" height="10"></div>
        </div>

        <div id="water_level8" title="Suction Tank" style="position: absolute; z-index: 2; top: 577px; left: 450px; width: 35px; height: 20px; background: transparent">
            <div id="show_level8color" class="waterlevel">
                <img id="show_level8" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level9" title="Suction Tank" style="position: absolute; z-index: 2; top: 560px; left:512px; width: 35px; height: 20px; background: transparent">
            <div id="show_level9color" class="waterlevel">
                <img id="show_level9" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level10" title="Suction Tank" style="position: absolute; z-index: 2; top: 593px; left: 512px; width: 35px; height: 20px; background: transparent">
            <div id="show_level10color" class="waterlevel">
                <img id="show_level10" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level11" title="Suction Tank" style="position: absolute; z-index: 2; top: 563px; left: 573px; width: 35px; height: 20px; background: transparent">
            <div id="show_level11color" class="waterlevel">
                <img id="show_level11" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level12" title="Suction Tank" style="position: absolute; z-index: 2; top: 563px; left: 633px; width: 35px; height: 20px; background: transparent">
            <div id="show_level12color" class="waterlevel">
                <img id="show_level12" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level13" title="Suction Tank" style="position: absolute; z-index: 2; top: 577px; left: 693px; width: 35px; height: 20px; background: transparent">
            <div id="show_level13color" class="waterlevel">
                <img id="show_level13" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level14" title="Suction Tank" style="position: absolute; z-index: 2; top: 577px; left: 753px; width: 35px; height: 20px; background: transparent">
            <div id="show_level14color" class="waterlevel">
                <img id="show_level14" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level15" title="Suction Tank" style="position: absolute; z-index: 2; top: 550px; left: 753px; width: 35px; height: 20px; background: transparent">
            <div id="show_level15color" class="waterlevel">
                <img id="show_level15" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level16" title="Suction Tank" style="position: absolute; z-index: 2; top: 526px; left: 813px; width: 35px; height: 20px; background: transparent">
            <div id="show_level16color" class="waterlevel">
                <img id="show_level16" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level17" title="Suction Tank" style="position: absolute; z-index: 2; top: 580px; left: 813px; width: 35px; height: 20px; background: transparent">
            <div id="show_level17color" class="waterlevel">
                <img id="show_level17" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level18" title="Suction Tank" style="position: absolute; z-index: 2; top: 543px; left: 872px; width: 35px; height: 20px; background: transparent">
            <div id="show_level18color" class="waterlevel">
                <img id="show_level18" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level19" title="Suction Tank" style="position: absolute; z-index: 2; top: 613px; left: 872px; width: 35px; height: 20px; background: transparent">
            <div id="show_level19color" class="waterlevel">
                <img id="show_level19" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level20" title="Suction Tank" style="position: absolute; z-index: 2; top: 625px; left: 930px; width: 35px; height: 20px; background: transparent">
            <div id="show_level20color" class="waterlevel">
                <img id="show_level20" src="../images/blank.gif" width="35" height="10"></div>
        </div>
          <div id="water_level21" title="Suction Tank" style="position: absolute; z-index: 2; top: 590px; left: 930px; width: 35px; height: 20px; background: transparent">
            <div id="show_level21color" class="waterlevel">
                <img id="show_level21" src="../images/blank.gif" width="35" height="10"></div>
        </div>


           
        <div style="position: absolute; top: 525px; left: 137px; z-index: 2;">
            <div id="l_level2_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top: 505px; left: 195px; z-index: 2;">
            <div id="l_level3_value" class="black_box">???</div>
        </div>

        <div style="position: absolute; top: 505px; left: 235px; z-index: 2;">
            <div id="l_level4_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 555px; left: 294px; z-index: 2;">
            <div id="l_level5_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 555px; left: 335px; z-index: 2;">
            <div id="l_level6_value" class="black_box">???</div>
        </div>
           <div style="position: absolute; top: 540px; left:395px; z-index: 2;">
            <div id="l_level7_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 525px; left:453px; z-index: 2;">
            <div id="l_level8_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 610px; left: 453px; z-index: 2;">
            <div id="l_level9_value" class="black_box">???</div>
        </div>
         <div style="position: absolute; top: 625px; left: 514px; z-index: 2;">
            <div id="l_level10_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 545px; left:514px; z-index: 2;">
            <div id="l_level11_value" class="black_box">???</div>
        </div>
        <div style="position: absolute; top: 545px; left: 575px; z-index: 2;">
            <div id="l_level12_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 545px; left: 635px; z-index: 2;">
            <div id="l_level13_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 562px; left: 697px; z-index: 2;">
            <div id="l_level14_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 534px; left: 755px; z-index: 2;">
            <div id="l_level15_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 610px; left: 755px; z-index: 2;">
            <div id="l_level16_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 510px; left: 815px; z-index: 2;">
            <div id="l_level17_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 565px; left: 815px; z-index: 2;">
            <div id="l_level18_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 530px; left: 875px; z-index: 2;">
            <div id="l_level19_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 595px; left: 875px; z-index: 2;">
            <div id="l_level20_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 575px; left: 935px; z-index: 2;">
            <div id="l_level21_value" class="black_box">???</div>
        </div>
          <div style="position: absolute; top: 655px; left: 935px; z-index: 2;">
            <div id="l_level22_value" class="black_box">???</div>
        </div>
