...
<link rel=StyleSheet href="_objects.css" title="Contemporary">
	...
	<div id="BPH" style="Z-INDEX:1;LEFT:2px;POSITION:absolute;TOP:1px">
			<img src="img/Hospital-Jasin.jpg">
			...
			<div id="water_level2" style="Z-INDEX:3;BACKGROUND:none transparent scroll repeat 0% 0%;LEFT:380px;WIDTH:309px;POSITION:absolute;TOP:340px;HEIGHT:60px">
			...
			<div style="Z-INDEX:3;LEFT:270px;CURSOR:pointer;POSITION:absolute;TOP:40px">
			...
			<div style="Z-INDEX:3;LEFT:366px;CURSOR:pointer;POSITION:absolute;TOP:185px">
