        ...
        <div align="center">
          <table border="0" cellspacing="1" width="100%">
            ...
            <tr>
              ...
              <optgroup label="User Management" style="FONT-FAMILY: Verdana;FONT-SIZE: 12px;FONT-WEIGHT: bold;">
                   <option value="User">- User Management </option>
                  <option value="Contact">- Contact Management </option>
             </optgroup> 
             <optgroup label="Unit Management" style ="font-family : Verdana ; font-size :12px;font-weight:bold;">
                  ...
                  <option value="Advanced">- Dispatch Management (User Advanced) </optgroup> 
                </select>
              </td>
            </tr>
            <tr>
...
<script language="javascript">
  ...
  function goPages(strPage)
  {
      if (strPage == "Dispatch") {
          ...
          document.frmAdmin.action = "ContactManagementSamb.aspx";
      }
          ...
          document.frmAdmin.action = "UserManagementSamb.aspx";
      }
      ...
      else if (strPage == "Advanced") {
          document.frmAdmin.action = "AddNewDispatchSAMB.aspx"
      }
